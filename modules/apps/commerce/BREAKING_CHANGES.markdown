...
1. **Accounts**: the price list is associated to specific accounts.

1. **Account Groups and Channels**: the price list is associated to specific
   account groups in specific channels.

1. **Account Groups**: the price list is associated to specific account groups.

1. **Channels**: the price list is associated to a specific channel.

1. **Unqualified**: the price list is not associated to any specific account,
...
1. **Price List Accounts**

1. **Price List Account Groups**

1. **Price List Account Channels**

1. **Price List Discounts**

1. **Price Modifiers**

1. **Tier Price Entries**
...
1. `getCommerceTierPriceEntriesCountByCompanyId(long)`
...
1. `getCommercePriceModifiersCount()`
have been deprecated and no replacement is provided.
...
1. `DELETE/PERMISSIONS/UPDATE/VIEW`: when permission to delete, modify
...
1. `com.liferay.commerce.price.list.service.impl.CommerceTierPriceEntryService#getCommerceTierPriceEntriesCountByCompanyId(long)`

1. `com.liferay.commerce.pricing.service.impl.CommercePriceModifierService#getCommercePriceModifiers(long, String)`

1. `com.liferay.commerce.pricing.service.impl.CommercePriceModifierService#getCommercePriceModifiersCount()`
