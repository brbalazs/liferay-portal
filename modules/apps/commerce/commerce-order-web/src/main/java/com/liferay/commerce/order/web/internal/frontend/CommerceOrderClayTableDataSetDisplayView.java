...
@Component(
	immediate = true,
	property = {
		"commerce.data.set.display.name=" + CommerceOrderDataSetConstants.COMMERCE_DATA_SET_KEY_OPEN_ORDERS,
		"commerce.data.set.display.name=" + CommerceOrderDataSetConstants.COMMERCE_DATA_SET_KEY_PENDING_ORDERS,
		"commerce.data.set.display.name=" + CommerceOrderDataSetConstants.COMMERCE_DATA_SET_KEY_TRANSMITTED_ORDERS
	},
...
public class CommerceOrderClayTableDataSetDisplayView
	...
	public ClayTableSchema getClayTableSchema() {
		...
		clayTableSchemaBuilder.addField("accountCode", "account-code");
