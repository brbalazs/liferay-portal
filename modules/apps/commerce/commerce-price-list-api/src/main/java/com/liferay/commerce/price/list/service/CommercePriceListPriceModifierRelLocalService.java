...
/**
 * Provides the local service interface for CommercePriceListPriceModifierRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Alessio Antonio Rendina
 * @see CommercePriceListPriceModifierRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CommercePriceListPriceModifierRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommercePriceListPriceModifierRelLocalServiceUtil} to access the commerce price list price modifier rel local service. Add custom service methods to <code>com.liferay.commerce.price.list.service.impl.CommercePriceListPriceModifierRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
