...
/**
 * Provides the local service interface for CommercePricingClassRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Riccardo Alberti
 * @see CommercePricingClassRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CommercePricingClassRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommercePricingClassRelLocalServiceUtil} to access the commerce pricing class rel local service. Add custom service methods to <code>com.liferay.commerce.pricing.service.impl.CommercePricingClassRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public CommercePricingClassRel createCommercePricingClassRel(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CommercePricingClassRel getCommercePricingClassRel(
			long commercePricingClassRelId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CommercePricingClassRel updateCommercePricingClassRel(
		CommercePricingClassRel commercePricingClassRel);
