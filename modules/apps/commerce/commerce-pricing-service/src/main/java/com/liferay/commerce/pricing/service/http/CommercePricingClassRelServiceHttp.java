 ...
 * @see CommercePricingClassRelServiceSoap
 * @generated
 */
public class CommercePricingClassRelServiceHttp {
	...
	public static com.liferay.commerce.pricing.model.CommercePricingClassRel
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommercePricingClassRelServiceUtil.class,
				"addCommerceDiscountRel",
				_addCommerceDiscountRelParameterTypes0);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, commercePricingClassId, className, classPK,
				serviceContext);
			...
			return (com.liferay.commerce.pricing.model.CommercePricingClassRel)
				returnObj;
		}
	...
	public static long[] getClassPKs(
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommercePricingClassRelServiceUtil.class, "getClassPKs",
				_getClassPKsParameterTypes3);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, commercePricingClassId, className);
	...
	public static java.util.List
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, commercePricingClassId, className, start, end,
				orderByComparator);
	...
	private static Log _log = LogFactoryUtil.getLog(
		CommercePricingClassRelServiceHttp.class);
