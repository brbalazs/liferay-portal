...
public class CommercePricingClassServiceHttp {
	...
	public static com.liferay.commerce.pricing.model.CommercePricingClass
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, userId, groupId, titleMap, descriptionMap,
				serviceContext);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommercePricingClassServiceUtil.class,
				"getCommercePricingClasses",
				_getCommercePricingClassesParameterTypes6);
	...
	public static com.liferay.commerce.pricing.model.CommercePricingClass
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommercePricingClassServiceUtil.class,
				"updateCommercePricingClass",
				_updateCommercePricingClassParameterTypes8);
	...
	public static com.liferay.commerce.pricing.model.CommercePricingClass
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommercePricingClassServiceUtil.class,
				"updateCommercePricingClass",
				_updateCommercePricingClassParameterTypes9);
	...
	public static com.liferay.commerce.pricing.model.CommercePricingClass
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommercePricingClassServiceUtil.class,
				"upsertCommercePricingClass",
				_upsertCommercePricingClassParameterTypes10);
	...
	public static com.liferay.commerce.pricing.model.CommercePricingClass
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommercePricingClassServiceUtil.class,
				"upsertCommercePricingClass",
				_upsertCommercePricingClassParameterTypes11);
	...
	private static final Class<?>[] _getCommercePricingClassParameterTypes5 =
		new Class[] {long.class};
	private static final Class<?>[] _getCommercePricingClassesParameterTypes6 =
		new Class[] {
	...
	private static final Class<?>[] _updateCommercePricingClassParameterTypes8 =
		new Class[] {
			long.class, long.class, long.class, java.util.Map.class,
			java.util.Map.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[] _updateCommercePricingClassParameterTypes9 =
		new Class[] {
			long.class, long.class, long.class, String.class, String.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[]
		_upsertCommercePricingClassParameterTypes10 = new Class[] {
			long.class, long.class, long.class, String.class, String.class,
			String.class, com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[]
		_upsertCommercePricingClassParameterTypes11 = new Class[] {
			long.class, long.class, long.class, java.util.Map.class,
