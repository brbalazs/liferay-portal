...
public class CommercePriceEntryDataSetActionProvider
	...
	public List<ClayDataSetAction> clayDataSetActions(
		...
		PriceEntry priceEntry = (PriceEntry)model;
		...
		if (_commercePriceListModelResourcePermission.contains(
			...
			PortletURL editURL = _getPriceEntryEditURL(
			...
			PortletURL deleteURL = _getPriceEntryDeleteURL(
				commercePriceEntry, httpServletRequest);
	...
	private PortletURL _getPriceEntryDeleteURL(
		CommercePriceEntry commercePriceEntry,
		...
		portletURL.setParameter(
			ActionRequest.ACTION_NAME, "editCommercePriceEntry");
	...
	private PortletURL _getPriceEntryEditURL(
			CommercePriceEntry commercePriceEntry,
			HttpServletRequest httpServletRequest)
		throws PortalException {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommercePriceEntryDataSetActionProvider.class);
