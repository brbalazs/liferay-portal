...
class CPDefinitionOptionValueDetail extends Component {
	constructor(opt_config, opt_parentElement) {
		...
		this.on(
			'cpDefinitionOptionValueRelIdChanged',
			this._handleCPDefinitionOptionValueChange
		);
	}
	...
	loadOptionValueDetail(cpDefinitionOptionValueRelId) {
		...
		url.searchParams.append(
			this.namespace + 'cpDefinitionId',
			this.cpDefinitionId
		);
		url.searchParams.append(
			this.namespace + 'cpDefinitionOptionValueRelId',
	...
	_saveOptionValue() {
		...
		form.querySelector(
			'[name=' + this.namespace + 'cpDefinitionOptionRelId]'
		).value = this.cpDefinitionOptionRelId;
