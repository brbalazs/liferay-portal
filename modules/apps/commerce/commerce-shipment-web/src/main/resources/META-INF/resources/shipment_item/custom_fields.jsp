...
<liferay-portlet:actionURL name="editCommerceShipmentItem" var="editCommerceShipmentItemActionURL" />
	...
	<aui:form action="<%= editCommerceShipmentItemActionURL %>" cssClass="container-fluid-1280" method="post" name="fm">
		<aui:fieldset>
			...
			<liferay-expando:custom-attribute-list
				...
				classPK="<%= (commerceShipmentItem != null) ? commerceShipmentItem.getCommerceShipmentItemId() : 0 %>"
				editable="<%= true %>"
				label="<%= true %>"
			/>
