...
public class SubscriptionPaymentsFilterFactoryImpl implements FilterFactory {

	@Override
	public Filter create(HttpServletRequest httpServletRequest) {
		SubscriptionPaymentsFilterImpl subscriptionEntryFilterImpl =
			new SubscriptionPaymentsFilterImpl();
