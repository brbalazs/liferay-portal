...
public class SubscriptionShipmentsFilterFactoryImpl implements FilterFactory {

	@Override
	public Filter create(HttpServletRequest httpServletRequest) {
		SubscriptionShipmentsFilterImpl subscriptionEntryFilterImpl =
			new SubscriptionShipmentsFilterImpl();
