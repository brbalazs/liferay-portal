...
public class CommerceOrderAddressNotificationTermTest {
	...
	public void setUp() throws Exception {
		...
		_commerceChannel = CommerceTestUtil.addCommerceChannel(
			groupId, _commerceCurrency.getCode());

		_commerceOrder = CommerceTestUtil.addB2CCommerceOrder(
			userId, _commerceChannel.getGroupId(), _commerceCurrency);
	...
	@Test
	public void testCreateNotificationWithCommerceOrderAddressTerms()
		throws Exception {
		...
		String transformedContent = NotificationTypeUtil.evaluateTerms(
			content,
		...
		String expectedContent = _createExpectedContent();

		Assert.assertEquals(expectedContent, transformedContent);
	}

	private String _createExpectedContent() throws Exception {
		...
		return StringBundler.concat(
			...
			" | ", shippingCountry.getTitle(), " | ", shippingAddress.getZip(),
			" | ", shippingAddress.getCity(), " | ", shippingRegion.getTitle(),
			" | ", billingAddress.getName(), " | ",
			billingAddress.getPhoneNumber(), " | ", billingAddress.getStreet1(),
			" | ", billingAddress.getStreet2(), " | ",
			billingAddress.getStreet3(), " | ", billingCountry.getTitle(),
			" | ", billingAddress.getZip(), " | ", billingAddress.getCity(),
