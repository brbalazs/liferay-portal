...
public class Query {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {accounts(filter: ___, page: ___, pageSize: ___, sorts: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {accountsPage(externalReferenceCode: ___){customFields, externalReferenceCode, id, name}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public AccountGroup accountsPage(
			@GraphQLName("externalReferenceCode") String externalReferenceCode)
		throws Exception {
		...
		return _applyComponentServiceObjects(
			_accountGroupResourceComponentServiceObjects,
			this::_populateResourceContext,
			accountGroupResource -> accountGroupResource.getAccountsPage(
				externalReferenceCode));
	}
	...
	public class GetAccountsPageTypeExtension {

		public GetAccountsPageTypeExtension(Account account) {
			_account = account;
		}

		@GraphQLField
		public AccountGroup sPage() throws Exception {
			return _applyComponentServiceObjects(
				_accountGroupResourceComponentServiceObjects,
	...
	@GraphQLTypeExtension(Account.class)
	public class GetAccountGroupTypeExtension {

		public GetAccountGroupTypeExtension(Account account) {
			_account = account;
		}

		@GraphQLField
		public AccountGroup group() throws Exception {
			return _applyComponentServiceObjects(
				_accountGroupResourceComponentServiceObjects,
				Query.this::_populateResourceContext,
	...
	@GraphQLTypeExtension(Account.class)
	public class GetAccountIdAccountMemberTypeExtension {

		public GetAccountIdAccountMemberTypeExtension(Account account) {
			_account = account;
		}

		@GraphQLField
		public AccountMember idAccountMember(@GraphQLName("userId") Long userId)
			throws Exception {
	...
	@GraphQLTypeExtension(Account.class)
	public class GetAccountIdAccountOrganizationsPageTypeExtension {

		public GetAccountIdAccountOrganizationsPageTypeExtension(
			Account account) {
		...
		@GraphQLField
		public AccountOrganizationPage idAccountOrganizations(
				@GraphQLName("pageSize") int pageSize,
				@GraphQLName("page") int page)
			throws Exception {
	...
	@GraphQLTypeExtension(Account.class)
	public class GetAccountIdAccountAddressesPageTypeExtension {

		public GetAccountIdAccountAddressesPageTypeExtension(Account account) {
			_account = account;
		}

		@GraphQLField
		public AccountAddressPage idAccountAddresses(
				@GraphQLName("pageSize") int pageSize,
				@GraphQLName("page") int page)
			throws Exception {
	...
	public class GetAccountTypeExtension {
		...
		public GetAccountTypeExtension(AccountGroup accountGroup) {
	...
	@GraphQLTypeExtension(Account.class)
	public class GetAccountIdAccountOrganizationTypeExtension {

		public GetAccountIdAccountOrganizationTypeExtension(Account account) {
			_account = account;
		}

		@GraphQLField
		public AccountOrganization idAccountOrganization(
				@GraphQLName("organizationId") Long organizationId)
			throws Exception {
	...
	@GraphQLTypeExtension(Account.class)
	public class GetAccountIdAccountMembersPageTypeExtension {

		public GetAccountIdAccountMembersPageTypeExtension(Account account) {
			_account = account;
		}

		@GraphQLField
		public AccountMemberPage idAccountMembers(
				@GraphQLName("pageSize") int pageSize,
				@GraphQLName("page") int page)
			throws Exception {
