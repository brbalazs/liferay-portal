	...
	public static class ProductGroupResourceImpl
		...
		public HttpInvoker.HttpResponse nullBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-admin-catalog/v1.0/productGroups/batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-admin-catalog/v1.0/productGroups/by-externalReferenceCode/{externalReferenceCode}",
				externalReferenceCode);
		...
		public HttpInvoker.HttpResponse deleteProductGroupHttpResponse(Long id)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-admin-catalog/v1.0/productGroups/{id}",
				id);
		...
		public HttpInvoker.HttpResponse nullBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-admin-catalog/v1.0/productGroups/{id}/batch",
				id);
