...
public abstract class BaseProductShippingConfigurationResourceTestCase {
	...
	protected void assertEqualsJSONArray(
		...
		for (ProductShippingConfiguration productShippingConfiguration :
			...
			for (Object object : jsonArray) {
				if (equalsJSONObject(
						productShippingConfiguration, (JSONObject)object)) {
			...
			Assert.assertTrue(
				jsonArray + " does not contain " + productShippingConfiguration,
				contains);
		}
	}
	...
	protected boolean equalsJSONObject(
		...
		for (String fieldName : getAdditionalAssertFieldNames()) {
			if (Objects.equals("freeShipping", fieldName)) {
				if (!Objects.deepEquals(
						productShippingConfiguration.getFreeShipping(),
						jsonObject.getBoolean("freeShipping"))) {
			...
			if (Objects.equals("shippable", fieldName)) {
				if (!Objects.deepEquals(
						productShippingConfiguration.getShippable(),
						jsonObject.getBoolean("shippable"))) {
			...
			if (Objects.equals("shippingSeparately", fieldName)) {
				if (!Objects.deepEquals(
						productShippingConfiguration.getShippingSeparately(),
						jsonObject.getBoolean("shippingSeparately"))) {
