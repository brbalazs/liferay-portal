...
public class Query {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {warehousByExternalReferenceCode(externalReferenceCode: ___){active, city, countryISOCode, description, externalReferenceCode, id, warehouseItems, latitude, longitude, name, regionISOCode, street1, street2, street3, type, zip}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {warehousId(id: ___){active, city, countryISOCode, description, externalReferenceCode, id, warehouseItems, latitude, longitude, name, regionISOCode, street1, street2, street3, type, zip}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
