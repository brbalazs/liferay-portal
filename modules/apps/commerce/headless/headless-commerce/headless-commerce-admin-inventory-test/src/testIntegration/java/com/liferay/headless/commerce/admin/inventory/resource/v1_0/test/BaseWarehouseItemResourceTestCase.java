...
public abstract class BaseWarehouseItemResourceTestCase {
	...
	public void testGraphQLDeleteWarehouseItem() throws Exception {
		...
		Assert.assertTrue(dataJSONObject.getBoolean("deleteWarehouseItem"));
	...
	public void testGraphQLGetWarehouseItem() throws Exception {
		...
		Assert.assertTrue(
			equalsJSONObject(
				warehouseItem, dataJSONObject.getJSONObject("warehouseItem")));
	}
	...
	protected void assertEqualsJSONArray(
		List<WarehouseItem> warehouseItems, JSONArray jsonArray) {

		for (WarehouseItem warehouseItem : warehouseItems) {
			boolean contains = false;

			for (Object object : jsonArray) {
				if (equalsJSONObject(warehouseItem, (JSONObject)object)) {
					contains = true;
			...
			Assert.assertTrue(
				jsonArray + " does not contain " + warehouseItem, contains);
		}
	}
	...
	protected boolean equalsJSONObject(
		WarehouseItem warehouseItem, JSONObject jsonObject) {
		...
		for (String fieldName : getAdditionalAssertFieldNames()) {
			...
			if (Objects.equals("id", fieldName)) {
				if (!Objects.deepEquals(
						warehouseItem.getId(), jsonObject.getLong("id"))) {
			...
			if (Objects.equals("reservedQuantity", fieldName)) {
				if (!Objects.deepEquals(
						warehouseItem.getReservedQuantity(),
						jsonObject.getInt("reservedQuantity"))) {
			...
			if (Objects.equals("sku", fieldName)) {
				if (!Objects.deepEquals(
						warehouseItem.getSku(), jsonObject.getString("sku"))) {
			...
			if (Objects.equals("warehouseExternalReferenceCode", fieldName)) {
				if (!Objects.deepEquals(
			...
			if (Objects.equals("warehouseId", fieldName)) {
				if (!Objects.deepEquals(
		...
		return new WarehouseItem() {
			{
				...
				warehouseExternalReferenceCode = RandomTestUtil.randomString();
