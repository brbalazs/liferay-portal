...
public abstract class BaseOrderItemResourceTestCase {
	...
	public void testGraphQLDeleteOrderItem() throws Exception {
		...
		Assert.assertTrue(dataJSONObject.getBoolean("deleteOrderItem"));
	...
	public void testGraphQLGetOrderItem() throws Exception {
		...
		Assert.assertTrue(
			equalsJSONObject(
				orderItem, dataJSONObject.getJSONObject("orderItem")));
	}
	...
	protected boolean equalsJSONObject(
		...
		for (String fieldName : getAdditionalAssertFieldNames()) {
			if (Objects.equals("bookedQuantityId", fieldName)) {
				if (!Objects.deepEquals(
						orderItem.getBookedQuantityId(),
						jsonObject.getLong("bookedQuantityId"))) {
			...
			if (Objects.equals("deliveryGroup", fieldName)) {
				if (!Objects.deepEquals(
						orderItem.getDeliveryGroup(),
						jsonObject.getString("deliveryGroup"))) {
			...
			if (Objects.equals("orderExternalReferenceCode", fieldName)) {
				if (!Objects.deepEquals(
						orderItem.getOrderExternalReferenceCode(),
						jsonObject.getString("orderExternalReferenceCode"))) {
			...
			if (Objects.equals("shippedQuantity", fieldName)) {
				if (!Objects.deepEquals(
						orderItem.getShippedQuantity(),
						jsonObject.getInt("shippedQuantity"))) {
			...
			if (Objects.equals("sku", fieldName)) {
				if (!Objects.deepEquals(
						orderItem.getSku(), jsonObject.getString("sku"))) {
			...
			if (Objects.equals("skuId", fieldName)) {
				if (!Objects.deepEquals(
						orderItem.getSkuId(), jsonObject.getLong("skuId"))) {
		...
		return new OrderItem() {
			{
				...
				orderExternalReferenceCode = RandomTestUtil.randomString();
