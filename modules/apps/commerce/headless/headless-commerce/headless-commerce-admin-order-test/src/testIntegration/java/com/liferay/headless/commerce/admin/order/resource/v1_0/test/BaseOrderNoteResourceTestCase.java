...
public abstract class BaseOrderNoteResourceTestCase {
	...
	public void testGraphQLGetOrderNote() throws Exception {
		...
		Assert.assertTrue(
			equalsJSONObject(
				orderNote, dataJSONObject.getJSONObject("orderNote")));
	}
	...
	protected void assertEqualsJSONArray(
		List<OrderNote> orderNotes, JSONArray jsonArray) {

		for (OrderNote orderNote : orderNotes) {
			boolean contains = false;

			for (Object object : jsonArray) {
				if (equalsJSONObject(orderNote, (JSONObject)object)) {
					contains = true;
			...
			Assert.assertTrue(
				jsonArray + " does not contain " + orderNote, contains);
		}
	}
	...
	protected boolean equalsJSONObject(
		OrderNote orderNote, JSONObject jsonObject) {
		...
		for (String fieldName : getAdditionalAssertFieldNames()) {
			...
			if (Objects.equals("id", fieldName)) {
				if (!Objects.deepEquals(
						orderNote.getId(), jsonObject.getLong("id"))) {
