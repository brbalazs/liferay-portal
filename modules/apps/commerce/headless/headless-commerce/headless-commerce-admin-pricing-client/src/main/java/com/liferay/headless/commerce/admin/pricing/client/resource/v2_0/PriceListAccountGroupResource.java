	...
	public static class PriceListAccountGroupResourceImpl
		...
		public HttpInvoker.HttpResponse deletePriceListAccountGroupHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-admin-pricing/v2.0/priceListAccountGroups/{id}",
				id);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-admin-pricing/v2.0/priceListAccountGroups/{id}/batch",
				id);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-admin-pricing/v2.0/priceLists/{id}/priceListAccountGroups",
				id);
