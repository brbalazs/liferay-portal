...
public abstract class BaseDiscountAccountGroupResourceTestCase {
	...
	public void testGraphQLDeleteDiscountAccountGroup() throws Exception {
		...
		Assert.assertTrue(
			dataJSONObject.getBoolean("deleteDiscountAccountGroup"));
	...
	protected void assertEqualsJSONArray(
		List<DiscountAccountGroup> discountAccountGroups, JSONArray jsonArray) {
		...
		for (DiscountAccountGroup discountAccountGroup :
			...
			for (Object object : jsonArray) {
				if (equalsJSONObject(
						discountAccountGroup, (JSONObject)object)) {
			...
			Assert.assertTrue(
				jsonArray + " does not contain " + discountAccountGroup,
				contains);
		}
	}
	...
	protected boolean equalsJSONObject(
		DiscountAccountGroup discountAccountGroup, JSONObject jsonObject) {
