...
public abstract class BasePriceModifierProductGroupResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		priceModifierProductGroup.setProductGroupName(regex);
		...
		Assert.assertEquals(
			regex, priceModifierProductGroup.getProductGroupName());
	}
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("productGroupName", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						priceModifierProductGroup1.getProductGroupName(),
						priceModifierProductGroup2.getProductGroupName())) {
