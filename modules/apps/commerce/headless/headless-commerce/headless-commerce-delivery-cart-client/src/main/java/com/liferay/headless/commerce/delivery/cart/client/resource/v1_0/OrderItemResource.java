...
public interface OrderItemResource {
	...
	public HttpInvoker.HttpResponse getChannelCartOrderItemsPageHttpResponse(
			Long cartId, Long channelId)
		throws Exception;

	public OrderItem getChannelCartOrderItem(
			Long cartId, Long channelId, Long orderItemId)
		throws Exception;

	public HttpInvoker.HttpResponse getChannelCartOrderItemHttpResponse(
			Long cartId, Long channelId, Long orderItemId)
		throws Exception;
	...
	public static class OrderItemResourceImpl implements OrderItemResource {
		...
		public Page<OrderItem> getChannelCartOrderItemsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getChannelCartOrderItemsPageHttpResponse(cartId, channelId);
		...
		public HttpInvoker.HttpResponse
				getChannelCartOrderItemsPageHttpResponse(
					Long cartId, Long channelId)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-delivery-cart/v1.0/channels/{channelId}/carts/{cartId}/orderItems",
				cartId, channelId);
		...
		public OrderItem getChannelCartOrderItem(
			...
			HttpInvoker.HttpResponse httpResponse =
				getChannelCartOrderItemHttpResponse(
		...
		public HttpInvoker.HttpResponse getChannelCartOrderItemHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-delivery-cart/v1.0/channels/{channelId}/carts/{cartId}/orderItems/{orderItemId}",
				cartId, channelId, orderItemId);
