...
public interface PaymentMethodResource {
	...
	public HttpInvoker.HttpResponse
			getChannelCartPaymentMethodsPageHttpResponse(
				Long channelId, Long cartId)
		throws Exception;
	...
	public static class PaymentMethodResourceImpl
		...
		public Page<PaymentMethod> getChannelCartPaymentMethodsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getChannelCartPaymentMethodsPageHttpResponse(channelId, cartId);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-delivery-cart/v1.0/channels/{channelId}/carts/{cartId}/payment-methods",
				channelId, cartId);
