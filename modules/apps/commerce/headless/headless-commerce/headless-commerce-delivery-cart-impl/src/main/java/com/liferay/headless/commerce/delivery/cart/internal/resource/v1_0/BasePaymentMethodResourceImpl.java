...
public abstract class BasePaymentMethodResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-cart/v1.0/channels/{channelId}/carts/{cartId}/payment-methods'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	...
	@Path("/channels/{channelId}/carts/{cartId}/payment-methods")
	...
	protected void preparePatch(
		PaymentMethod paymentMethod, PaymentMethod existingPaymentMethod) {
	}
