...
public abstract class BaseShippingMethodResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-cart/v1.0/channels/{channelId}/carts/{cartId}/shipping-methods'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	...
	@Path("/channels/{channelId}/carts/{cartId}/shipping-methods")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "ShippingMethod")})
	public Page<ShippingMethod> getChannelCartShippingMethodsPage(
	...
	protected void preparePatch(
		ShippingMethod shippingMethod, ShippingMethod existingShippingMethod) {
	}
