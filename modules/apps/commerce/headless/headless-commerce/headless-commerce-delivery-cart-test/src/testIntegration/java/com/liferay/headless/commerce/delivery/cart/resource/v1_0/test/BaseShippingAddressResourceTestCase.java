...
import com.liferay.headless.commerce.delivery.cart.client.dto.v1_0.ShippingAddress;
import com.liferay.headless.commerce.delivery.cart.client.http.HttpInvoker;
import com.liferay.headless.commerce.delivery.cart.client.pagination.Page;
import com.liferay.headless.commerce.delivery.cart.client.resource.v1_0.ShippingAddressResource;
import com.liferay.headless.commerce.delivery.cart.client.serdes.v1_0.ShippingAddressSerDes;
...
public abstract class BaseShippingAddressResourceTestCase {
	...
	@Test
	public void testGetChannelCartShippingAddress() throws Exception {
		ShippingAddress postShippingAddress =
			testGetChannelCartShippingAddress_addShippingAddress();
	...
	@Test
	public void testGraphQLGetChannelCartShippingAddress() throws Exception {
		...
		Assert.assertTrue(
			equalsJSONObject(
				shippingAddress,
				dataJSONObject.getJSONObject("channelCartShippingAddress")));
	}

	@Test
	public void testPatchChannelCartShippingAddress() throws Exception {
