...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Headless Commerce Delivery Catalog API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Headless Commerce Delivery Catalog API", version = "v1.0")
)
@Path("/v1.0")
