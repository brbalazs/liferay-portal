...
public abstract class BasePunchoutSessionResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/oheadless-commerce-punchout/v1.0/punchout/session/request' -d $'{"buyerGroup": ___, "buyerOrganization": ___, "buyerUser": ___, "cart": ___, "punchoutReturnURL": ___, "punchoutSessionRedirectURL": ___, "punchoutSessionType": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@Override
