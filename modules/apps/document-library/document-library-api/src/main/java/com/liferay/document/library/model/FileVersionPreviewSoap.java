...
public class FileVersionPreviewSoap implements Serializable {
	...
	public static FileVersionPreviewSoap[] toSoapModels(
		...
		FileVersionPreviewSoap[] soapModels =
			new FileVersionPreviewSoap[models.length];
	...
	public static FileVersionPreviewSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels =
				new FileVersionPreviewSoap[models.length][models[0].length];
		}
		else {
	...
	public static FileVersionPreviewSoap[] toSoapModels(
		...
		List<FileVersionPreviewSoap> soapModels =
			new ArrayList<FileVersionPreviewSoap>(models.size());
		...
		return soapModels.toArray(
			new FileVersionPreviewSoap[soapModels.size()]);
	}
