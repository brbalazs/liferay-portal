...
public class FileVersionPreviewLocalServiceWrapper
	 ...
	 */
	@Override
	public com.liferay.document.library.model.FileVersionPreview
		addFileVersionPreview(
			com.liferay.document.library.model.FileVersionPreview
				fileVersionPreview) {

		return _fileVersionPreviewLocalService.addFileVersionPreview(
			fileVersionPreview);
	}
	...
	public com.liferay.document.library.model.FileVersionPreview
		...
		return _fileVersionPreviewLocalService.createFileVersionPreview(
			fileVersionPreviewId);
	}

	@Override
	public void deleteFileEntryFileVersionPreviews(long fileEntryId) {
		_fileVersionPreviewLocalService.deleteFileEntryFileVersionPreviews(
			fileEntryId);
	}
	...
	@Override
	public com.liferay.document.library.model.FileVersionPreview
		deleteFileVersionPreview(
			com.liferay.document.library.model.FileVersionPreview
				fileVersionPreview) {

		return _fileVersionPreviewLocalService.deleteFileVersionPreview(
			fileVersionPreview);
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel deletePersistedModel(
		...
		return _fileVersionPreviewLocalService.deletePersistedModel(
			persistedModel);
	}
	...
	public long dynamicQueryCount(
		...
		return _fileVersionPreviewLocalService.dynamicQueryCount(
	...
	public com.liferay.document.library.model.FileVersionPreview
		...
		return _fileVersionPreviewLocalService.fetchFileVersionPreview(
			fileVersionPreviewId);
	}

	@Override
	public com.liferay.document.library.model.FileVersionPreview
		fetchFileVersionPreview(long fileEntryId, long fileVersionId) {
	...
	@Override
	public java.util.List<com.liferay.document.library.model.FileVersionPreview>
		getFileEntryFileVersionPreviews(long fileEntryId) {

		return _fileVersionPreviewLocalService.getFileEntryFileVersionPreviews(
			fileEntryId);
	}
	...
	public com.liferay.document.library.model.FileVersionPreview
		...
		return _fileVersionPreviewLocalService.getFileVersionPreview(
			fileVersionPreviewId);
	}

	@Override
	public com.liferay.document.library.model.FileVersionPreview
			getFileVersionPreview(long fileEntryId, long fileVersionId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public java.util.List<com.liferay.document.library.model.FileVersionPreview>
		...
		return _fileVersionPreviewLocalService.getFileVersionPreviews(
			start, end);
	}
	...
	public boolean hasFileVersionPreview(
		...
		return _fileVersionPreviewLocalService.hasFileVersionPreview(
			fileEntryId, fileVersionId, previewStatus);
	}
	...
	@Override
	public com.liferay.document.library.model.FileVersionPreview
		updateFileVersionPreview(
			com.liferay.document.library.model.FileVersionPreview
				fileVersionPreview) {

		return _fileVersionPreviewLocalService.updateFileVersionPreview(
			fileVersionPreview);
	}
	...
	public void updateFileVersionPreview(
		...
		_fileVersionPreviewLocalService.updateFileVersionPreview(
			fileVersionPreviewId, previewStatus);
	}
