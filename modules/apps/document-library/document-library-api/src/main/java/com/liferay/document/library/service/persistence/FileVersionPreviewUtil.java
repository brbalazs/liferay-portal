...
/**
 * The persistence utility for the file version preview service. This utility wraps <code>com.liferay.document.library.service.persistence.impl.FileVersionPreviewPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class FileVersionPreviewUtil {
	 ...
	 */
	public static List<FileVersionPreview> findByFileEntryId(
	 ...
	 */
	public static FileVersionPreview findByFileEntryId_First(
			long fileEntryId,
			OrderByComparator<FileVersionPreview> orderByComparator)
	 ...
	 * @throws NoSuchFileVersionPreviewException if a matching file version preview could not be found
	 */
	public static FileVersionPreview findByFileEntryId_Last(
			long fileEntryId,
			OrderByComparator<FileVersionPreview> orderByComparator)
		throws com.liferay.document.library.exception.
			NoSuchFileVersionPreviewException {
	 ...
	 */
	public static FileVersionPreview fetchByFileEntryId_Last(
		long fileEntryId,
		OrderByComparator<FileVersionPreview> orderByComparator) {
	...
	public static FileVersionPreview[] findByFileEntryId_PrevAndNext(
		...
		return getPersistence().findByFileEntryId_PrevAndNext(
			fileVersionPreviewId, fileEntryId, orderByComparator);
	}
	...
	public static FileVersionPreview[] findByFileVersionId_PrevAndNext(
		...
		return getPersistence().findByFileVersionId_PrevAndNext(
			fileVersionPreviewId, fileVersionId, orderByComparator);
	}
	 ...
	 * @throws NoSuchFileVersionPreviewException if a matching file version preview could not be found
	 */
	public static FileVersionPreview findByF_F(
	 ...
	 */
	public static FileVersionPreview fetchByF_F(
		long fileEntryId, long fileVersionId) {
	 ...
	 */
	public static FileVersionPreview removeByF_F(
			long fileEntryId, long fileVersionId)
		throws com.liferay.document.library.exception.
			NoSuchFileVersionPreviewException {
	 ...
	 * @throws NoSuchFileVersionPreviewException if a matching file version preview could not be found
	 */
	public static FileVersionPreview findByF_F_P(
	 ...
	 * @return the matching file version preview, or <code>null</code> if a matching file version preview could not be found
	 */
	public static FileVersionPreview fetchByF_F_P(
		long fileEntryId, long fileVersionId, int previewStatus) {
	 ...
	 * @return the file version preview that was removed
	 */
	public static FileVersionPreview removeByF_F_P(
			long fileEntryId, long fileVersionId, int previewStatus)
		throws com.liferay.document.library.exception.
			NoSuchFileVersionPreviewException {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			FileVersionPreviewPersistence.class);
