...
public class DDMServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register(
			"2.0.6", "2.0.7",
			new com.liferay.dynamic.data.mapping.internal.upgrade.v2_0_7.
				UpgradeDDMFormFieldValidation(_jsonFactory));

		registry.register(
			"2.0.7", "2.0.8",
			new com.liferay.dynamic.data.mapping.internal.upgrade.v2_0_8.
				UpgradeDDMContent(_jsonFactory));

		registry.register(
			"2.0.8", "2.0.9",
			new com.liferay.dynamic.data.mapping.internal.upgrade.v2_0_9.
				UpgradeSchema());

		registry.register(
			"2.0.9", "2.0.10",
			new com.liferay.dynamic.data.mapping.internal.upgrade.v2_0_10.
