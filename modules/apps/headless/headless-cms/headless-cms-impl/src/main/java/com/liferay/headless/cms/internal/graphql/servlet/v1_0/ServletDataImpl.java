...
import com.liferay.headless.cms.internal.resource.v1_0.AssetPermissionResourceImpl;
...
public class ServletDataImpl implements ServletData {
	...
	public void activate(BundleContext bundleContext) {
		Mutation.setAssetPermissionResourceComponentServiceObjects(
	...
	private static final Map<String, ObjectValuePair<Class<?>, String>>
		_resourceMethodObjectValuePairs =
			new HashMap<String, ObjectValuePair<Class<?>, String>>() {
				{
					put(
						"mutation#updateAssetPermissionReset",
						new ObjectValuePair<>(
							AssetPermissionResourceImpl.class,
							"putAssetPermissionReset"));
					put(
