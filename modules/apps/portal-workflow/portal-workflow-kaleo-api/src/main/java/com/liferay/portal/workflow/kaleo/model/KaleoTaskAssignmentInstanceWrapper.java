...
public class KaleoTaskAssignmentInstanceWrapper
	...
	public Object clone() {
		return new KaleoTaskAssignmentInstanceWrapper(
			(KaleoTaskAssignmentInstance)_kaleoTaskAssignmentInstance.clone());
	}
	...
	public int compareTo(
		...
		return _kaleoTaskAssignmentInstance.compareTo(
	...
	public void setKaleoDefinitionVersionId(long kaleoDefinitionVersionId) {
		_kaleoTaskAssignmentInstance.setKaleoDefinitionVersionId(
			kaleoDefinitionVersionId);
	}
	...
	public void setKaleoInstanceTokenId(long kaleoInstanceTokenId) {
		_kaleoTaskAssignmentInstance.setKaleoInstanceTokenId(
			kaleoInstanceTokenId);
	}
	...
	public void setKaleoTaskAssignmentInstanceId(
		...
		_kaleoTaskAssignmentInstance.setKaleoTaskAssignmentInstanceId(
			kaleoTaskAssignmentInstanceId);
	}
	...
	public void setKaleoTaskInstanceTokenId(long kaleoTaskInstanceTokenId) {
		_kaleoTaskAssignmentInstance.setKaleoTaskInstanceTokenId(
			kaleoTaskInstanceTokenId);
	}
	...
	public com.liferay.portal.kernel.model.CacheModel
		<KaleoTaskAssignmentInstance> toCacheModel() {
	...
	public KaleoTaskAssignmentInstance toEscapedModel() {
		return new KaleoTaskAssignmentInstanceWrapper(
			_kaleoTaskAssignmentInstance.toEscapedModel());
	}
	...
	public KaleoTaskAssignmentInstance toUnescapedModel() {
		return new KaleoTaskAssignmentInstanceWrapper(
			_kaleoTaskAssignmentInstance.toUnescapedModel());
	}
