...
public class KaleoTaskInstanceTokenWrapper
	...
	public Object clone() {
		return new KaleoTaskInstanceTokenWrapper(
			(KaleoTaskInstanceToken)_kaleoTaskInstanceToken.clone());
	}
	...
	public void setKaleoDefinitionVersionId(long kaleoDefinitionVersionId) {
		_kaleoTaskInstanceToken.setKaleoDefinitionVersionId(
			kaleoDefinitionVersionId);
	}
	...
	public void setKaleoTaskInstanceTokenId(long kaleoTaskInstanceTokenId) {
		_kaleoTaskInstanceToken.setKaleoTaskInstanceTokenId(
			kaleoTaskInstanceTokenId);
	}
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<KaleoTaskInstanceToken>
		toCacheModel() {
	...
	public KaleoTaskInstanceToken toEscapedModel() {
		return new KaleoTaskInstanceTokenWrapper(
			_kaleoTaskInstanceToken.toEscapedModel());
	}
	...
	public KaleoTaskInstanceToken toUnescapedModel() {
		return new KaleoTaskInstanceTokenWrapper(
			_kaleoTaskInstanceToken.toUnescapedModel());
	}
