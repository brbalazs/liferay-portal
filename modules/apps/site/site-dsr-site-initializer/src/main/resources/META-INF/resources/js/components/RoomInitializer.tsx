...
import {
	TRoomContext,
	TRoomDataContext,
	TRoomInitializerProps,
} from '../common/utils/types';
import RoomAccountAssociationStep from './RoomAccountAssociationStep';
import RoomNameStep from './RoomNameStep';
import RoomSelectTemplateStep from './RoomSelectTemplateStep';

const DEFAULT_DATA_CONTEXT: TRoomDataContext = {
	banner: {},
	clientLogo: {},
	clientName: '',
	errors: {},
...
const STEPS_DEFINITION = [
	{
		numberOfSteps: 1,
		steps: [RoomAccountAssociationStep],
	},
	{
		numberOfSteps: 2,
		steps: [RoomAccountAssociationStep, RoomSelectTemplateStep],
	},
	{
		numberOfSteps: 3,
		steps: [
			RoomAccountAssociationStep,
