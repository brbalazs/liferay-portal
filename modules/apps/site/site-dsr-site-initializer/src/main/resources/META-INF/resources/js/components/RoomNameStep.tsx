...
function RoomNameStep({
	...
	const generateFriendlyURL = useCallback((roomName: string): string => {
		if (!roomName) {
			return '';
		}
	...
	const handleRoomNameChange = useCallback(
		({target: {value}}: React.ChangeEvent<HTMLInputElement>) => {
			const friendlyURL = generateFriendlyURL(value);
		...
		[generateFriendlyURL, setDataContext]
	);
