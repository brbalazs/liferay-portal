...
public class CommerceAccountBranchesScreenNavigationEntry
	...
	public String getCategoryKey() {
		return CommerceAccountScreenNavigationConstants.
			CATEGORY_KEY_ACCOUNT_BRANCHES;
	}

	@Override
	public String getEntryKey() {
		return CommerceAccountScreenNavigationConstants.
			ENTRY_KEY_ACCOUNT_BRANCHES;
	}

	@Override
	public String getLabel(Locale locale) {
		return LanguageUtil.get(locale, "head-offices");
	}
