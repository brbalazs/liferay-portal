...
CommerceAddress commerceAddress = commerceAccountAddressesDisplayContext.getCommerceAddress();
CommerceAccount commerceAccount = commerceAccountAddressesDisplayContext.getCurrentCommerceAccount();

long commerceAddressId = commerceAccountAddressesDisplayContext.getCommerceAddressId();
long commerceCountryId = commerceAccountAddressesDisplayContext.getCommerceCountryId();
long commerceRegionId = commerceAccountAddressesDisplayContext.getCommerceRegionId();
			...
			<aui:row>
				...
				<aui:col width="<%= 50 %>">
					...
					<aui:select label="country" name="commerceCountryId" showEmptyOption="<%= true %>">
						...
						<%
						List<CommerceCountry> commerceCountries = commerceAccountAddressesDisplayContext.getCommerceCountries();
