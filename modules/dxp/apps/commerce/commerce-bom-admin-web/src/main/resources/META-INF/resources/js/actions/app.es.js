...
const initializeAppData = (dispatch) => (data) => dispatch(
    { 
...
const setError = (dispatch) => (error) => dispatch(
    { 
...
const setLoading = (dispatch) => (loading) => dispatch(
    { 
...
const setSpritemap = (dispatch) => (spritemap) => dispatch(
    { 
