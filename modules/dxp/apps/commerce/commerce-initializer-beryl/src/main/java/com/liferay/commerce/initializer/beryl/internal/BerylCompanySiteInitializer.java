...
public class BerylCompanySiteInitializer
	...
	public void portalInstanceRegistered(Company company)
		...
		if (!expandoBridge.hasAttribute(_RUN_BERYL_COMPANY_SITE_INITIALIZER)) {
			expandoBridge.addAttribute(
				_RUN_BERYL_COMPANY_SITE_INITIALIZER,
		...
		expandoBridge.setAttribute(
			_RUN_BERYL_COMPANY_SITE_INITIALIZER, false, false);
	}
	...
	private static final String _BERYL_COMPANY_SITE_INITIALIZER_ENABLED =
		"beryl.company.site.initializer.enabled";

	private static final String _RUN_BERYL_COMPANY_SITE_INITIALIZER =
		"run-beryl-company-site-initializer";

	private static final boolean _SITE_INITIALIZER_ENABLED =
		GetterUtil.getBoolean(
			PropsUtil.get(_BERYL_COMPANY_SITE_INITIALIZER_ENABLED));

	private static final Log _log = LogFactoryUtil.getLog(
		BerylCompanySiteInitializer.class);

	@Reference(
		target = "(site.initializer.key=" + BerylSiteInitializer.KEY + ")"
	)
