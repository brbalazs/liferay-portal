 ...
 */
@Component(service = BerylSampleOrdersInitializer.class)
public class BerylSampleOrdersInitializer extends BaseBerylSampleInitializer {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BerylSampleOrdersInitializer.class);
