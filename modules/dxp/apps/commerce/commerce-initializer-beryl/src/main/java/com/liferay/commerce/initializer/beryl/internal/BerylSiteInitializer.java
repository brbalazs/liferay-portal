...
@Component(
	immediate = true,
	property = "site.initializer.key=" + BerylSiteInitializer.KEY,
	service = SiteInitializer.class
)
public class BerylSiteInitializer implements SiteInitializer {

	public static final int ACCOUNT_ORGANIZATIONS_COUNT = 3;

	public static final String DEPENDENCY_PATH =
		"com/liferay/commerce/initializer/beryl/internal/dependencies/";

	public static final String KEY = "beryl-initializer";
	...
	public boolean isActive(long companyId) {
		Theme theme = _themeLocalService.fetchTheme(companyId, _BERYL_THEME_ID);

		if (theme == null) {
			if (_log.isInfoEnabled()) {
				_log.info(_BERYL_THEME_ID + " is not registered");
			}
