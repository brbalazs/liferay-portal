...
package com.liferay.commerce.theme.minium.impl.internal.product.renderer.list;
...
import com.liferay.commerce.theme.minium.impl.internal.product.model.ProductCompareModel;
...
public class MiniumCPCompareListRenderer implements CPContentListRenderer {
	...
	public void render(
		...
		ComponentDescriptor testDescriptor = new ComponentDescriptor(
			...
			"commerce-theme-minium-impl@1.0.4/products_compare" +
				"/ProductsCompare.es",
			null, null);
