...
public class MiniumCPContentListEntryRenderer
	...
	public void render(
		...
		dependencies.add(
			"commerce-frontend-taglib@1.1.0/add_to_cart/AddToCartButton.es");
		dependencies.add(
			"commerce-frontend-taglib@1.1.0/compare_checkbox" +
				"/CompareCheckbox.es");
		dependencies.add("commerce-frontend-taglib@1.1.0/price/Price.es");
