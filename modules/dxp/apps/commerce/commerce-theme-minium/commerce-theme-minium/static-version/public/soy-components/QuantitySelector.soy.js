...
function $render(opt_data, opt_ijData, opt_ijData_deprecated) {
  ...
  var prevClass__soy928 = '';
  prevClass__soy928 += isPrevAvailable == false ? ' is-disabled' : '';
  var nextClass__soy935 = '';
  nextClass__soy935 += isNextAvailable == false ? ' is-disabled' : '';
  ...
  incrementalDom.elementOpenEnd();
    if ((allowedOptions != null)) {
      ...
      incrementalDom.elementOpenEnd();
        ...
        incrementalDom.elementOpenEnd();
          var option959List = allowedOptions;
          var option959ListLen = option959List.length;
          for (var option959Index = 0; option959Index < option959ListLen; option959Index++) {
              var option959Data = option959List[option959Index];
              var optionAttributes__soy946 = function() {
                incrementalDom.attr('value', option959Data);
                if (option959Data == quantity) {
                  incrementalDom.attr('selected', 'selected');
                }
              };
              incrementalDom.elementOpenStart('option');
                  optionAttributes__soy946();
              incrementalDom.elementOpenEnd();
                soyIdom.print(option959Data);
      ...
      incrementalDom.elementOpenStart('a');
          ...
          incrementalDom.attr('class', 'quantity-selector__btn' + prevClass__soy928);
      ...
      incrementalDom.elementOpenStart('a');
          incrementalDom.attr('href', '#');
          incrementalDom.attr('class', 'quantity-selector__btn' + nextClass__soy935);
