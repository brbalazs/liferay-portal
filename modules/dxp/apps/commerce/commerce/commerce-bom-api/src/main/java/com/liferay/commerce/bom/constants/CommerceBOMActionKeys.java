...
public class CommerceBOMActionKeys {
	...
	public static final String VIEW_COMMERCE_BOM_DEFINITIONS =
		"VIEW_COMMERCE_BOM_DEFINITIONS";

	public static final String VIEW_COMMERCE_BOM_FOLDERS =
		"VIEW_COMMERCE_BOM_FOLDERS";
