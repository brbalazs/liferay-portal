 ...
 * <code>com.liferay.commerce.cloud.client.service.impl.CommerceCloudForecastOrderLocalServiceImpl</code> and
...
public class CommerceCloudForecastOrderLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.commerce.cloud.client.service.impl.CommerceCloudForecastOrderLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static
		com.liferay.commerce.cloud.client.model.CommerceCloudForecastOrder
			addCommerceCloudForecastOrder(
				com.liferay.commerce.cloud.client.model.
					CommerceCloudForecastOrder commerceCloudForecastOrder) {

		return getService().addCommerceCloudForecastOrder(
	...
	public static
		com.liferay.commerce.cloud.client.model.CommerceCloudForecastOrder
			createCommerceCloudForecastOrder(
				long commerceCloudForecastOrderId) {

		return getService().createCommerceCloudForecastOrder(
	...
	public static
		...
		return getService().deleteCommerceCloudForecastOrder(
			commerceCloudForecastOrder);
	}
	...
	public static
		...
		return getService().deleteCommerceCloudForecastOrderByCommerceOrderId(
			commerceOrderId);
	}
	...
	public static
		...
		return getService().fetchCommerceCloudForecastOrder(
			commerceCloudForecastOrderId);
	}
	...
	public static
		...
		return getService().getCommerceCloudForecastOrder(
			commerceCloudForecastOrderId);
	}
	...
	public static
		...
		return getService().updateCommerceCloudForecastOrder(
			commerceCloudForecastOrder);
	}
	...
	private static ServiceTracker
		<CommerceCloudForecastOrderLocalService,
		 CommerceCloudForecastOrderLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommerceCloudForecastOrderLocalService.class);

		ServiceTracker
			<CommerceCloudForecastOrderLocalService,
			 CommerceCloudForecastOrderLocalService> serviceTracker =
				new ServiceTracker
					<CommerceCloudForecastOrderLocalService,
					 CommerceCloudForecastOrderLocalService>(
