...
/**
 * The persistence utility for the commerce cloud forecast order service. This utility wraps <code>com.liferay.commerce.cloud.client.service.persistence.impl.CommerceCloudForecastOrderPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CommerceCloudForecastOrderUtil {
	 ...
	 */
	public static Map<Serializable, CommerceCloudForecastOrder>
	...
	public static CommerceCloudForecastOrder update(
		...
		return getPersistence().update(
			commerceCloudForecastOrder, serviceContext);
	}
	...
	public static CommerceCloudForecastOrder findByCommerceOrderId(
		...
		throws com.liferay.commerce.cloud.client.exception.
			NoSuchCloudForecastOrderException {
	...
	public static CommerceCloudForecastOrder fetchByCommerceOrderId(
		...
		return getPersistence().fetchByCommerceOrderId(
			commerceOrderId, retrieveFromCache);
	}
	...
	public static List<CommerceCloudForecastOrder> findBySyncDate(
		...
		return getPersistence().findBySyncDate(
			syncDate, start, end, orderByComparator);
	}
	...
	public static List<CommerceCloudForecastOrder> findBySyncDate(
		...
		return getPersistence().findBySyncDate(
			syncDate, start, end, orderByComparator, retrieveFromCache);
	}
	...
	public static CommerceCloudForecastOrder findBySyncDate_First(
		...
		return getPersistence().findBySyncDate_First(
	...
	public static CommerceCloudForecastOrder fetchBySyncDate_First(
		...
		return getPersistence().fetchBySyncDate_First(
			syncDate, orderByComparator);
	}
	...
	public static CommerceCloudForecastOrder findBySyncDate_Last(
		...
		return getPersistence().findBySyncDate_Last(
			syncDate, orderByComparator);
	}
	...
	public static CommerceCloudForecastOrder fetchBySyncDate_Last(
		...
		return getPersistence().fetchBySyncDate_Last(
			syncDate, orderByComparator);
	}
	...
	public static CommerceCloudForecastOrder[] findBySyncDate_PrevAndNext(
		...
		return getPersistence().findBySyncDate_PrevAndNext(
			commerceCloudForecastOrderId, syncDate, orderByComparator);
	}
	...
	private static ServiceTracker
		<CommerceCloudForecastOrderPersistence,
		 CommerceCloudForecastOrderPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommerceCloudForecastOrderPersistence.class);

		ServiceTracker
			<CommerceCloudForecastOrderPersistence,
			 CommerceCloudForecastOrderPersistence> serviceTracker =
				new ServiceTracker
					<CommerceCloudForecastOrderPersistence,
					 CommerceCloudForecastOrderPersistence>(
