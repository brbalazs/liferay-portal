 ...
 */
@ProviderType
public class CommerceDataIntegrationProcessNameException extends PortalException {
	...
	public CommerceDataIntegrationProcessNameException(String msg, Throwable cause) {
		super(msg, cause);
	}
