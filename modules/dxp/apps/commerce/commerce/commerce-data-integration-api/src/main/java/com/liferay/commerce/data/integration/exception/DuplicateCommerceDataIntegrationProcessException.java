 ...
 */
@ProviderType
public class DuplicateCommerceDataIntegrationProcessException extends PortalException {
	...
	public DuplicateCommerceDataIntegrationProcessException(String msg, Throwable cause) {
		super(msg, cause);
	}
