 ...
 * <code>com.liferay.commerce.data.integration.manager.service.impl.HistoryLocalServiceImpl</code> and
...
public class HistoryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.commerce.data.integration.manager.service.impl.HistoryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static com.liferay.commerce.data.integration.manager.model.History
		...
		return getService().addHistory(
			userId, scheduledTaskId, executionType, startDate, endDate, status,
			errorLogFileEntryId, runtimeLogFileEntryId);
	}
	...
	public static com.liferay.commerce.data.integration.manager.model.History
		...
		return getService().addHistory(
			scheduledTaskId, executionType, status, serviceContext);
	}
	 ...
	 */
	public static com.liferay.commerce.data.integration.manager.model.History
		fetchHistoryByUuidAndGroupId(String uuid, long groupId) {
	...
	public static java.util.List
		<com.liferay.commerce.data.integration.manager.model.History>
			getHistories(int start, int end) {
	...
	public static java.util.List
		<com.liferay.commerce.data.integration.manager.model.History>
			getHistoriesByGoupId(long groupId, int start, int end) {
	...
	public static java.util.List
		<com.liferay.commerce.data.integration.manager.model.History>
			getHistoriesByUuidAndCompanyId(String uuid, long companyId) {
	...
	public static java.util.List
		<com.liferay.commerce.data.integration.manager.model.History>
			getHistoriesByUuidAndCompanyId(
				String uuid, long companyId, int start, int end,
				com.liferay.portal.kernel.util.OrderByComparator
					<com.liferay.commerce.data.integration.manager.model.
						History> orderByComparator) {

		return getService().getHistoriesByUuidAndCompanyId(
	 ...
	 */
	public static com.liferay.commerce.data.integration.manager.model.History
			getHistoryByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static com.liferay.commerce.data.integration.manager.model.History
		...
		return getService().updateHistory(
			historyId, scheduledTaskId, executionType, status, serviceContext);
	}
	...
	private static ServiceTracker<HistoryLocalService, HistoryLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(HistoryLocalService.class);

		ServiceTracker<HistoryLocalService, HistoryLocalService>
			serviceTracker =
				new ServiceTracker<HistoryLocalService, HistoryLocalService>(
					bundle.getBundleContext(), HistoryLocalService.class, null);
