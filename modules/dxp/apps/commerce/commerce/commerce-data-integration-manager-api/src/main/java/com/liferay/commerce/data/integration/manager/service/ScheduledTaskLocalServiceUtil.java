 ...
 * <code>com.liferay.commerce.data.integration.manager.service.impl.ScheduledTaskLocalServiceImpl</code> and
...
public class ScheduledTaskLocalServiceUtil {
	...
	public static int countScheduledTasksByActive(
	...
	public static int countScheduledTasksByGroupId_Enabled(
		long groupId, boolean enabled) {

		return getService().countScheduledTasksByGroupId_Enabled(
			groupId, enabled);
	}
	...
	public static java.util.List
		...
		return getService().getScheduledTasksByGroupId_Active(
	...
	public static java.util.List
		...
		return getService().getScheduledTasksByGroupId_Enabled(
	...
	public static java.util.List
		...
		return getService().getScheduledTasksByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	private static ServiceTracker
		<ScheduledTaskLocalService, ScheduledTaskLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			ScheduledTaskLocalService.class);

		ServiceTracker<ScheduledTaskLocalService, ScheduledTaskLocalService>
			serviceTracker =
				new ServiceTracker
