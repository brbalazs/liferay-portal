...
public class ScheduledTaskLocalServiceWrapper
	...
	public com.liferay.commerce.data.integration.manager.model.ScheduledTask
		...
		return _scheduledTaskLocalService.addScheduledTask(
	...
	public int countScheduledTasksByActive(long groupId, boolean active) {
		return _scheduledTaskLocalService.countScheduledTasksByActive(
			groupId, active);
	}
	...
	public int countScheduledTasksByGroupId_Enabled(
		...
		return _scheduledTaskLocalService.countScheduledTasksByGroupId_Enabled(
			groupId, enabled);
	}
	...
	@Override
	public com.liferay.commerce.data.integration.manager.model.ScheduledTask
		createScheduledTask(long scheduledTaskId) {
	...
	@Override
	public com.liferay.commerce.data.integration.manager.model.ScheduledTask
			deleteScheduledTask(long scheduledTaskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public com.liferay.commerce.data.integration.manager.model.ScheduledTask
			disableScheduledTask(long scheduledTaskId, long userId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _scheduledTaskLocalService.disableScheduledTask(
	...
	public long dynamicQueryCount(
		...
		return _scheduledTaskLocalService.dynamicQueryCount(
			dynamicQuery, projection);
	}

	@Override
	public com.liferay.commerce.data.integration.manager.model.ScheduledTask
			enableScheduledTask(long scheduledTaskId, long userId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _scheduledTaskLocalService.enableScheduledTask(
			scheduledTaskId, userId);
	}

	@Override
	public com.liferay.commerce.data.integration.manager.model.ScheduledTask
		fetchScheduledTask(long scheduledTaskId) {
	...
	@Override
	public com.liferay.commerce.data.integration.manager.model.ScheduledTask
		fetchScheduledTaskByUuidAndGroupId(String uuid, long groupId) {

		return _scheduledTaskLocalService.fetchScheduledTaskByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery
		...
		return _scheduledTaskLocalService.getExportActionableDynamicQuery(
			portletDataContext);
	}
	...
	@Override
	public com.liferay.commerce.data.integration.manager.model.ScheduledTask
			getScheduledTask(long scheduledTaskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public java.util.List
		...
		return _scheduledTaskLocalService.getScheduledTaskByGroupId(
			groupId, start, end);
	}

	@Override
	public int getScheduledTaskByGroupIdCount(long groupId) {
		return _scheduledTaskLocalService.getScheduledTaskByGroupIdCount(
			groupId);
	}
	...
	@Override
	public com.liferay.commerce.data.integration.manager.model.ScheduledTask
			getScheduledTaskByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _scheduledTaskLocalService.getScheduledTaskByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public java.util.List
		<com.liferay.commerce.data.integration.manager.model.ScheduledTask>
			getScheduledTasks(int start, int end) {
	...
	public java.util.List
		<com.liferay.commerce.data.integration.manager.model.ScheduledTask>
			getScheduledTasksByActive(boolean active, int start, int end) {

		return _scheduledTaskLocalService.getScheduledTasksByActive(
			active, start, end);
	}
	...
	public java.util.List
		<com.liferay.commerce.data.integration.manager.model.ScheduledTask>
			getScheduledTasksByEnabled(boolean enabled, int start, int end) {

		return _scheduledTaskLocalService.getScheduledTasksByEnabled(
			enabled, start, end);
	}
	...
	public java.util.List
		<com.liferay.commerce.data.integration.manager.model.ScheduledTask>
			getScheduledTasksByGroupId_Active(
				long groupId, boolean active, int start, int end) {

		return _scheduledTaskLocalService.getScheduledTasksByGroupId_Active(
	...
	public java.util.List
		<com.liferay.commerce.data.integration.manager.model.ScheduledTask>
			getScheduledTasksByGroupId_Enabled(
				long groupId, boolean enabled, int start, int end) {

		return _scheduledTaskLocalService.getScheduledTasksByGroupId_Enabled(
	...
	public java.util.List
		<com.liferay.commerce.data.integration.manager.model.ScheduledTask>
			getScheduledTasksByUuidAndCompanyId(String uuid, long companyId) {

		return _scheduledTaskLocalService.getScheduledTasksByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	@Override
	public com.liferay.commerce.data.integration.manager.model.ScheduledTask
			startScheduledTask(long userId, long scheduledTaskId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _scheduledTaskLocalService.startScheduledTask(
			userId, scheduledTaskId);
	}

	@Override
	public com.liferay.commerce.data.integration.manager.model.ScheduledTask
			stopScheduledTask(long userId, long scheduledTaskId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _scheduledTaskLocalService.stopScheduledTask(
			userId, scheduledTaskId);
	}
	...
	public com.liferay.commerce.data.integration.manager.model.ScheduledTask
		...
		return _scheduledTaskLocalService.updateScheduledTask(
