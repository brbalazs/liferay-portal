...
public interface HistoryPersistence extends BasePersistence<History> {
	 ...
	 */
	public java.util.List<History> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<History>
			orderByComparator);
	 ...
	 * @return the range of matching histories
	 */
	public java.util.List<History> findByUuid_C(
	 ...
	 * @return the range of matching histories
	 */
	public java.util.List<History> findByGroupId(
	 ...
	 */
	public java.util.List<History> filterFindByGroupId(
		long groupId, int start, int end);
	 ...
	 * @return the matching histories
	 */
	public java.util.List<History> findByGroupId_Status(
	 ...
	 * @return the matching histories that the user has permission to view
	 */
	public java.util.List<History> filterFindByGroupId_Status(
		long groupId, int status);
	 ...
	 * @return the matching histories
	 */
	public java.util.List<History> findByScheduledTaskId(
