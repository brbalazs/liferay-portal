...
public interface ProcessPersistence extends BasePersistence<Process> {
	 ...
	 */
	public java.util.List<Process> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Process>
			orderByComparator);
	 ...
	 * @return the range of matching processes
	 */
	public java.util.List<Process> findByUuid_C(
	 ...
	 * @return the range of matching processes
	 */
	public java.util.List<Process> findByGroupId(
	 ...
	 */
	public java.util.List<Process> filterFindByGroupId(
		long groupId, int start, int end);
	 ...
	 * @return the matching processes
	 */
	public java.util.List<Process> findByProcessType_CompanyId(
