...
/**
 * The persistence utility for the process service. This utility wraps <code>com.liferay.commerce.data.integration.manager.service.persistence.impl.ProcessPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ProcessUtil {
	...
	public static Process update(
		Process process, ServiceContext serviceContext) {
	 ...
	 */
	public static List<Process> findByUuid(
	 ...
	 */
	public static Process findByUuid_First(
	 ...
	 */
	public static Process fetchByUuid_First(
		String uuid, OrderByComparator<Process> orderByComparator) {
	 ...
	 * @throws NoSuchProcessException if a matching process could not be found
	 */
	public static Process findByUuid_Last(
			String uuid, OrderByComparator<Process> orderByComparator)
		throws com.liferay.commerce.data.integration.manager.exception.
			NoSuchProcessException {
	 ...
	 */
	public static Process fetchByUuid_Last(
		String uuid, OrderByComparator<Process> orderByComparator) {
	 ...
	 */
	public static Process[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			processId, uuid, orderByComparator);
	}
	 ...
	 * @return the matching process, or <code>null</code> if a matching process could not be found
	 */
	public static Process fetchByUUID_G(
	 ...
	 * @return the range of matching processes
	 */
	public static List<Process> findByUuid_C(
	 ...
	 * @throws NoSuchProcessException if a matching process could not be found
	 */
	public static Process findByUuid_C_First(
	 ...
	 * @return the first matching process, or <code>null</code> if a matching process could not be found
	 */
	public static Process fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<Process> orderByComparator) {
	 ...
	 * @throws NoSuchProcessException if a matching process could not be found
	 */
	public static Process findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<Process> orderByComparator)
		throws com.liferay.commerce.data.integration.manager.exception.
			NoSuchProcessException {
	 ...
	 * @return the last matching process, or <code>null</code> if a matching process could not be found
	 */
	public static Process fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<Process> orderByComparator) {
	 ...
	 * @throws NoSuchProcessException if a process with the primary key could not be found
	 */
	public static Process[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			processId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @return the range of matching processes
	 */
	public static List<Process> findByGroupId(
	 ...
	 * @throws NoSuchProcessException if a matching process could not be found
	 */
	public static Process findByGroupId_First(
	 ...
	 * @return the first matching process, or <code>null</code> if a matching process could not be found
	 */
	public static Process fetchByGroupId_First(
		long groupId, OrderByComparator<Process> orderByComparator) {
	 ...
	 * @throws NoSuchProcessException if a matching process could not be found
	 */
	public static Process findByGroupId_Last(
			long groupId, OrderByComparator<Process> orderByComparator)
		throws com.liferay.commerce.data.integration.manager.exception.
			NoSuchProcessException {
	 ...
	 * @return the last matching process, or <code>null</code> if a matching process could not be found
	 */
	public static Process fetchByGroupId_Last(
		long groupId, OrderByComparator<Process> orderByComparator) {
	 ...
	 * @throws NoSuchProcessException if a process with the primary key could not be found
	 */
	public static Process[] findByGroupId_PrevAndNext(
	 ...
	 */
	public static List<Process> filterFindByGroupId(
		long groupId, int start, int end) {
	 ...
	 * @throws NoSuchProcessException if a process with the primary key could not be found
	 */
	public static Process[] filterFindByGroupId_PrevAndNext(
			long processId, long groupId,
			OrderByComparator<Process> orderByComparator)
		throws com.liferay.commerce.data.integration.manager.exception.
			NoSuchProcessException {
	 ...
	 * @return the matching process, or <code>null</code> if a matching process could not be found
	 */
	public static Process fetchByCompanyId_Name(
		long companyId, String name, boolean retrieveFromCache) {

		return getPersistence().fetchByCompanyId_Name(
			companyId, name, retrieveFromCache);
	}
	 ...
	 * @return the matching processes
	 */
	public static List<Process> findByProcessType_CompanyId(
		long companyId, String processType) {

		return getPersistence().findByProcessType_CompanyId(
	...
	public static List<Process> findByProcessType_CompanyId(
		...
		return getPersistence().findByProcessType_CompanyId(
			companyId, processType, start, end);
	}
	 ...
	 * @throws NoSuchProcessException if a matching process could not be found
	 */
	public static Process findByProcessType_CompanyId_First(
			long companyId, String processType,
			OrderByComparator<Process> orderByComparator)
		throws com.liferay.commerce.data.integration.manager.exception.
			NoSuchProcessException {

		return getPersistence().findByProcessType_CompanyId_First(
	 ...
	 * @return the first matching process, or <code>null</code> if a matching process could not be found
	 */
	public static Process fetchByProcessType_CompanyId_First(
		long companyId, String processType,
		OrderByComparator<Process> orderByComparator) {

		return getPersistence().fetchByProcessType_CompanyId_First(
			companyId, processType, orderByComparator);
	}
	 ...
	 * @throws NoSuchProcessException if a matching process could not be found
	 */
	public static Process findByProcessType_CompanyId_Last(
			long companyId, String processType,
			OrderByComparator<Process> orderByComparator)
		throws com.liferay.commerce.data.integration.manager.exception.
			NoSuchProcessException {

		return getPersistence().findByProcessType_CompanyId_Last(
			companyId, processType, orderByComparator);
	}
	 ...
	 * @return the last matching process, or <code>null</code> if a matching process could not be found
	 */
	public static Process fetchByProcessType_CompanyId_Last(
		long companyId, String processType,
		OrderByComparator<Process> orderByComparator) {

		return getPersistence().fetchByProcessType_CompanyId_Last(
			companyId, processType, orderByComparator);
	}
	...
	public static Process[] findByProcessType_CompanyId_PrevAndNext(
		...
		return getPersistence().findByProcessType_CompanyId_PrevAndNext(
			processId, companyId, processType, orderByComparator);
	}
	 ...
	 * @param processType the process type
	 */
	public static void removeByProcessType_CompanyId(
		long companyId, String processType) {
	 ...
	 * @return the number of matching processes
	 */
	public static int countByProcessType_CompanyId(
		long companyId, String processType) {

		return getPersistence().countByProcessType_CompanyId(
			companyId, processType);
	}
	...
	private static ServiceTracker<ProcessPersistence, ProcessPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ProcessPersistence.class);

		ServiceTracker<ProcessPersistence, ProcessPersistence> serviceTracker =
			new ServiceTracker<ProcessPersistence, ProcessPersistence>(
				bundle.getBundleContext(), ProcessPersistence.class, null);
