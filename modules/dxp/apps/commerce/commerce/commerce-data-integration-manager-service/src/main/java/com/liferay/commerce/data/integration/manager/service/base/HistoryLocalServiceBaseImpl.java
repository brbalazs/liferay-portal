 ...
 */
@ProviderType
public abstract class HistoryLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HistoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.commerce.data.integration.manager.service.HistoryLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			History.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return historyPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return historyPersistence.countWithDynamicQuery(
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<History>() {
	...
	public List<History> getHistoriesByUuidAndCompanyId(
		...
		return historyPersistence.findByUuid_C(
