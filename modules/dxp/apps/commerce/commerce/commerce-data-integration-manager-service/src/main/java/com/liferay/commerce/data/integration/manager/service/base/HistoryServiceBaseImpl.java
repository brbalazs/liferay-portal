 ...
 * @generated
 */
public abstract class HistoryServiceBaseImpl
	extends BaseServiceImpl implements HistoryService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HistoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.commerce.data.integration.manager.service.HistoryServiceUtil</code>.
	 */
	...
	@BeanReference(
		type = com.liferay.commerce.data.integration.manager.service.ScheduledTaskService.class
	)
	protected
		com.liferay.commerce.data.integration.manager.service.
			ScheduledTaskService scheduledTaskService;
