 ...
 */
@ProviderType
public abstract class ProcessLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProcessLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.commerce.data.integration.manager.service.ProcessLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Process.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return processPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return processPersistence.countWithDynamicQuery(
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Process>() {
	...
	public List<Process> getProcessesByUuidAndCompanyId(
		...
		return processPersistence.findByUuid_C(
