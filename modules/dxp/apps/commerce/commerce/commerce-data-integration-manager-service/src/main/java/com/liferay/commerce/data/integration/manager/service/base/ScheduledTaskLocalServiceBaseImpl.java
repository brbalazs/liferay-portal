...
public abstract class ScheduledTaskLocalServiceBaseImpl
	...
	implements ScheduledTaskLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ScheduledTaskLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.commerce.data.integration.manager.service.ScheduledTaskLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ScheduledTask.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return scheduledTaskPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return scheduledTaskPersistence.countWithDynamicQuery(
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<ScheduledTask>() {
				...
				public void performAction(ScheduledTask scheduledTask)
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, scheduledTask);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return scheduledTaskLocalService.deleteScheduledTask(
			(ScheduledTask)persistedModel);
	}
	...
	public List<ScheduledTask> getScheduledTasksByUuidAndCompanyId(
		...
		return scheduledTaskPersistence.findByUuid_C(
