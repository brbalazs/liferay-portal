 ...
 * @generated
 */
public abstract class ScheduledTaskServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ScheduledTaskService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.commerce.data.integration.manager.service.ScheduledTaskServiceUtil</code>.
	 */
	 ...
	 */
	public
		com.liferay.commerce.data.integration.manager.service.
			HistoryLocalService getHistoryLocalService() {
	 ...
	 */
	public com.liferay.commerce.data.integration.manager.service.HistoryService
		getHistoryService() {
	...
	public void setHistoryService(
		com.liferay.commerce.data.integration.manager.service.HistoryService
			historyService) {
	...
	public
		com.liferay.commerce.data.integration.manager.service.
			ProcessLocalService getProcessLocalService() {
	 ...
	 */
	public com.liferay.commerce.data.integration.manager.service.ProcessService
		getProcessService() {
	...
	public void setProcessService(
		com.liferay.commerce.data.integration.manager.service.ProcessService
			processService) {
	 ...
	 */
	public com.liferay.commerce.data.integration.manager.service.
		ScheduledTaskLocalService getScheduledTaskLocalService() {
	...
	@BeanReference(
		type = com.liferay.commerce.data.integration.manager.service.HistoryLocalService.class
	)
	protected
		com.liferay.commerce.data.integration.manager.service.
			HistoryLocalService historyLocalService;
	...
	@BeanReference(
		type = com.liferay.commerce.data.integration.manager.service.HistoryService.class
	)
	protected
		com.liferay.commerce.data.integration.manager.service.HistoryService
			historyService;
	...
	@BeanReference(
		type = com.liferay.commerce.data.integration.manager.service.ProcessLocalService.class
	)
	protected
		com.liferay.commerce.data.integration.manager.service.
			ProcessLocalService processLocalService;
	...
	@BeanReference(
		type = com.liferay.commerce.data.integration.manager.service.ProcessService.class
	)
	protected
		com.liferay.commerce.data.integration.manager.service.ProcessService
			processService;
	...
	@BeanReference(
		type = com.liferay.commerce.data.integration.manager.service.ScheduledTaskLocalService.class
	)
	protected com.liferay.commerce.data.integration.manager.service.
		ScheduledTaskLocalService scheduledTaskLocalService;
