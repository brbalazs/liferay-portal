 ...
 * <code>com.liferay.commerce.data.integration.manager.model.ScheduledTaskSoap</code>. If the method in the
 * service utility returns a
 * <code>com.liferay.commerce.data.integration.manager.model.ScheduledTask</code>, that is translated to a
 * <code>com.liferay.commerce.data.integration.manager.model.ScheduledTaskSoap</code>. Methods that SOAP
...
public class ScheduledTaskServiceSoap {
		...
		try {
			java.util.List
				<com.liferay.commerce.data.integration.manager.model.
					ScheduledTask> returnValue =
						ScheduledTaskServiceUtil.getScheduledTaskByGroupId(
							groupId, start, end);

			return com.liferay.commerce.data.integration.manager.model.
				ScheduledTaskSoap.toSoapModels(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	public static int getScheduledTaskByGroupIdCount(long groupId)
		...
		try {
			int returnValue =
				ScheduledTaskServiceUtil.getScheduledTaskByGroupIdCount(
					groupId);
	...
	public static
		...
		try {
			com.liferay.commerce.data.integration.manager.model.ScheduledTask
				returnValue = ScheduledTaskServiceUtil.updateScheduledTask(
	...
	private static Log _log = LogFactoryUtil.getLog(
		ScheduledTaskServiceSoap.class);
