 ...
 * <code>com.liferay.commerce.forecast.service.impl.CommerceForecastEntryLocalServiceImpl</code> and
...
public class CommerceForecastEntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.commerce.forecast.service.impl.CommerceForecastEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.liferay.commerce.forecast.model.CommerceForecastEntry
	...
	public static com.liferay.commerce.forecast.model.CommerceForecastEntry
		...
		return getService().addCommerceForecastEntry(
	...
	public static com.liferay.commerce.forecast.model.CommerceForecastEntry
		...
		return getService().createCommerceForecastEntry(
	...
	public static com.liferay.commerce.forecast.model.CommerceForecastEntry
		...
		return getService().deleteCommerceForecastEntry(
			commerceForecastEntryId);
	}
	...
	public static com.liferay.commerce.forecast.model.CommerceForecastEntry
		...
		return getService().fetchCommerceForecastEntry(
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommerceForecastEntryLocalService.class);

		ServiceTracker
			<CommerceForecastEntryLocalService,
			 CommerceForecastEntryLocalService> serviceTracker =
				new ServiceTracker
					<CommerceForecastEntryLocalService,
					 CommerceForecastEntryLocalService>(
