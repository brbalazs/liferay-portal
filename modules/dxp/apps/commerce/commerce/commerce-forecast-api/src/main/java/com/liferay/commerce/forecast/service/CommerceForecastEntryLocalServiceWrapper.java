...
public class CommerceForecastEntryLocalServiceWrapper
	 ...
	 */
	@Override
	public com.liferay.commerce.forecast.model.CommerceForecastEntry
		addCommerceForecastEntry(
			com.liferay.commerce.forecast.model.CommerceForecastEntry
				commerceForecastEntry) {

		return _commerceForecastEntryLocalService.addCommerceForecastEntry(
			commerceForecastEntry);
	}
	...
	public com.liferay.commerce.forecast.model.CommerceForecastEntry
		...
		return _commerceForecastEntryLocalService.addCommerceForecastEntry(
			companyId, userId, time, period, target, customerId, cpInstanceId,
			assertivity);
	}
	...
	@Override
	public com.liferay.commerce.forecast.model.CommerceForecastEntry
		createCommerceForecastEntry(long commerceForecastEntryId) {

		return _commerceForecastEntryLocalService.createCommerceForecastEntry(
	...
	@Override
	public com.liferay.commerce.forecast.model.CommerceForecastEntry
		deleteCommerceForecastEntry(
			com.liferay.commerce.forecast.model.CommerceForecastEntry
				commerceForecastEntry) {

		return _commerceForecastEntryLocalService.deleteCommerceForecastEntry(
			commerceForecastEntry);
	}
	...
	@Override
	public com.liferay.commerce.forecast.model.CommerceForecastEntry
			deleteCommerceForecastEntry(long commerceForecastEntryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public com.liferay.portal.kernel.model.PersistedModel deletePersistedModel(
		...
		return _commerceForecastEntryLocalService.deletePersistedModel(
			persistedModel);
	}
	...
	public long dynamicQueryCount(
		...
		return _commerceForecastEntryLocalService.dynamicQueryCount(
			dynamicQuery);
	}
	...
	@Override
	public com.liferay.commerce.forecast.model.CommerceForecastEntry
		fetchCommerceForecastEntry(long commerceForecastEntryId) {

		return _commerceForecastEntryLocalService.fetchCommerceForecastEntry(
			commerceForecastEntryId);
	}
	...
	public java.util.List
		<com.liferay.commerce.forecast.model.CommerceForecastEntry>
			getCommerceForecastEntries(int start, int end) {

		return _commerceForecastEntryLocalService.getCommerceForecastEntries(
			start, end);
	}
	...
	public int getCommerceForecastEntriesCount() {
		return _commerceForecastEntryLocalService.
			getCommerceForecastEntriesCount();
	}
	...
	@Override
	public com.liferay.commerce.forecast.model.CommerceForecastEntry
			getCommerceForecastEntry(long commerceForecastEntryId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _commerceForecastEntryLocalService.getCommerceForecastEntry(
			commerceForecastEntryId);
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel getPersistedModel(
		...
		return _commerceForecastEntryLocalService.getPersistedModel(
			primaryKeyObj);
	}
	...
	@Override
	public com.liferay.commerce.forecast.model.CommerceForecastEntry
		updateCommerceForecastEntry(
			com.liferay.commerce.forecast.model.CommerceForecastEntry
				commerceForecastEntry) {

		return _commerceForecastEntryLocalService.updateCommerceForecastEntry(
			commerceForecastEntry);
	}
