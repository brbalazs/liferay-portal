...
public class CommerceForecastEntryUtil {
	 ...
	 */
	public static Map<Serializable, CommerceForecastEntry> fetchByPrimaryKeys(
	 ...
	 */
	public static List<CommerceForecastEntry> findByCompanyId(
	 ...
	 */
	public static CommerceForecastEntry findByCompanyId_First(
			long companyId,
			OrderByComparator<CommerceForecastEntry> orderByComparator)
		throws com.liferay.commerce.forecast.exception.
			NoSuchForecastEntryException {
	 ...
	 */
	public static CommerceForecastEntry fetchByCompanyId_First(
		long companyId,
		OrderByComparator<CommerceForecastEntry> orderByComparator) {
	 ...
	 * @throws NoSuchForecastEntryException if a matching commerce forecast entry could not be found
	 */
	public static CommerceForecastEntry findByCompanyId_Last(
			long companyId,
			OrderByComparator<CommerceForecastEntry> orderByComparator)
		throws com.liferay.commerce.forecast.exception.
			NoSuchForecastEntryException {
	 ...
	 */
	public static CommerceForecastEntry fetchByCompanyId_Last(
		long companyId,
		OrderByComparator<CommerceForecastEntry> orderByComparator) {
	...
	public static CommerceForecastEntry[] findByCompanyId_PrevAndNext(
		...
		return getPersistence().findByCompanyId_PrevAndNext(
			commerceForecastEntryId, companyId, orderByComparator);
	}
	 ...
	 * @throws NoSuchForecastEntryException if a matching commerce forecast entry could not be found
	 */
	public static CommerceForecastEntry findByC_P_T_C_C(
			long companyId, int period, int target, long customerId,
			long CPInstanceId)
		throws com.liferay.commerce.forecast.exception.
			NoSuchForecastEntryException {

		return getPersistence().findByC_P_T_C_C(
	 ...
	 */
	public static CommerceForecastEntry fetchByC_P_T_C_C(
		long companyId, int period, int target, long customerId,
		long CPInstanceId) {

		return getPersistence().fetchByC_P_T_C_C(
			companyId, period, target, customerId, CPInstanceId);
	}
	 ...
	 */
	public static CommerceForecastEntry removeByC_P_T_C_C(
			long companyId, int period, int target, long customerId,
			long CPInstanceId)
		throws com.liferay.commerce.forecast.exception.
			NoSuchForecastEntryException {

		return getPersistence().removeByC_P_T_C_C(
			companyId, period, target, customerId, CPInstanceId);
	}
	 ...
	 * @return the number of matching commerce forecast entries
	 */
	public static int countByC_P_T_C_C(
		long companyId, int period, int target, long customerId,
		long CPInstanceId) {

		return getPersistence().countByC_P_T_C_C(
			companyId, period, target, customerId, CPInstanceId);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommerceForecastEntryPersistence.class);
