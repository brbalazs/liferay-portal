 ...
 */
@ProviderType
public interface CommerceForecastValuePersistence
	extends BasePersistence<CommerceForecastValue> {
	...
	public java.util.List<CommerceForecastValue> findByCommerceForecastEntryId(
		long commerceForecastEntryId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<CommerceForecastValue>
			orderByComparator);
	...
	public CommerceForecastValue findByCommerceForecastEntryId_First(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<CommerceForecastValue> orderByComparator)
