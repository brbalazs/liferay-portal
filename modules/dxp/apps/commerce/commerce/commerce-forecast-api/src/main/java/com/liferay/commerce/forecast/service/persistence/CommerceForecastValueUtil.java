...
/**
 * The persistence utility for the commerce forecast value service. This utility wraps <code>com.liferay.commerce.forecast.service.persistence.impl.CommerceForecastValuePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CommerceForecastValueUtil {
	 ...
	 */
	public static Map<Serializable, CommerceForecastValue> fetchByPrimaryKeys(
	...
	public static List<CommerceForecastValue> findByCommerceForecastEntryId(
		...
		return getPersistence().findByCommerceForecastEntryId(
	...
	public static List<CommerceForecastValue> findByCommerceForecastEntryId(
		...
		return getPersistence().findByCommerceForecastEntryId(
			commerceForecastEntryId, start, end);
	}
	...
	public static CommerceForecastValue findByCommerceForecastEntryId_First(
			long commerceForecastEntryId,
			OrderByComparator<CommerceForecastValue> orderByComparator)
		throws com.liferay.commerce.forecast.exception.
			NoSuchForecastValueException {

		return getPersistence().findByCommerceForecastEntryId_First(
	...
	public static CommerceForecastValue fetchByCommerceForecastEntryId_First(
		...
		return getPersistence().fetchByCommerceForecastEntryId_First(
			commerceForecastEntryId, orderByComparator);
	}
	...
	public static CommerceForecastValue findByCommerceForecastEntryId_Last(
		...
		return getPersistence().findByCommerceForecastEntryId_Last(
			commerceForecastEntryId, orderByComparator);
	}
	...
	public static CommerceForecastValue fetchByCommerceForecastEntryId_Last(
		...
		return getPersistence().fetchByCommerceForecastEntryId_Last(
			commerceForecastEntryId, orderByComparator);
	}
	 ...
	 */
	public static CommerceForecastValue[]
			findByCommerceForecastEntryId_PrevAndNext(
				long commerceForecastValueId, long commerceForecastEntryId,
				OrderByComparator<CommerceForecastValue> orderByComparator)
		throws com.liferay.commerce.forecast.exception.
			NoSuchForecastValueException {

		return getPersistence().findByCommerceForecastEntryId_PrevAndNext(
			commerceForecastValueId, commerceForecastEntryId,
			orderByComparator);
	}
	...
	public static void removeByCommerceForecastEntryId(
		...
		getPersistence().removeByCommerceForecastEntryId(
			commerceForecastEntryId);
	}
	...
	public static int countByCommerceForecastEntryId(
		...
		return getPersistence().countByCommerceForecastEntryId(
			commerceForecastEntryId);
	}
	...
	public static CommerceForecastValue fetchByC_T(
		...
		return getPersistence().fetchByC_T(
			commerceForecastEntryId, time, retrieveFromCache);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommerceForecastValuePersistence.class);
