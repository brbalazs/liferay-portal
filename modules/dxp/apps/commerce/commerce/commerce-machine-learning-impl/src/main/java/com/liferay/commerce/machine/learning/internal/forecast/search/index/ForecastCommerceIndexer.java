...
public class ForecastCommerceIndexer implements CommerceIndexer {
	...
	private static final String _INDEX_MAPPING_FILE_NAME =
		"/META-INF/search/commerce-forecast-document-type.json";

	private static final String _INDEX_NAME_PREFIX = "commerce-forecast-%s";
