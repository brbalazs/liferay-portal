...
public class BaseCommerceMLForecastServiceImplTest {
	...
	@Test
	public void testGetSearchSizeMonth() {
		CommerceMLForecastPeriod commerceMLForecastPeriod =
			CommerceMLForecastPeriod.MONTH;

		LocalDateTime testTestLocalDateTime = LocalDateTime.of(
			2019, 9, 21, 13, 2, 45);

		Date testDate = _toDate(testTestLocalDateTime);

		Date endDate = _baseCommerceMLForecastService.getEndDate(
			testDate, commerceMLForecastPeriod, 3);

		Date startDate = _baseCommerceMLForecastService.getStartDate(
			testDate, commerceMLForecastPeriod, 8);

		int searchSize = _baseCommerceMLForecastService.getSearchSize(
			startDate, endDate, commerceMLForecastPeriod);

		Assert.assertEquals(12, searchSize);
	}

	@Test
	public void testGetSearchSizeMonthZeroStep() {
		CommerceMLForecastPeriod commerceMLForecastPeriod =
			CommerceMLForecastPeriod.MONTH;
		...
		Date endDate = _baseCommerceMLForecastService.getEndDate(
			testDate, commerceMLForecastPeriod, 0);
		...
		Assert.assertEquals(1, searchSize);
	}

	@Test
	public void testGetSearchSizeWeek() {
		CommerceMLForecastPeriod commerceMLForecastPeriod =
			CommerceMLForecastPeriod.WEEK;
	...
	@Test
	public void testGetSearchSizeWeekZeroStep() {
		CommerceMLForecastPeriod commerceMLForecastPeriod =
			CommerceMLForecastPeriod.WEEK;
