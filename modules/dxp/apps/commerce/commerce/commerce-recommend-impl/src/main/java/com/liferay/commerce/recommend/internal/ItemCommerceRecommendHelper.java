...
public class ItemCommerceRecommendHelper implements CommerceRecommendHelper {
	...
	public Hits getRecommendations(
		...
		Sort rankSort = SortFactoryUtil.create("rank", Sort.INT_TYPE, false);
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ItemCommerceRecommendHelper.class);
