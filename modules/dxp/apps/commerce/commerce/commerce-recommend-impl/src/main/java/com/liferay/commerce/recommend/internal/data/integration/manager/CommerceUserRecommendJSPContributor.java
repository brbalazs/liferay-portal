...
@Component(
	immediate = true,
	property = "commerce.data.integration.process.type.key=" + CommerceUserRecommendScheduledTaskExecutorService.NAME,
	service = ProcessTypeJSPContributor.class
)
public class CommerceUserRecommendJSPContributor
