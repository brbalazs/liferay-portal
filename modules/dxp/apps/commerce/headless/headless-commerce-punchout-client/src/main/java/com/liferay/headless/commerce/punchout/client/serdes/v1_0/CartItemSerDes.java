...
import com.liferay.headless.commerce.punchout.client.dto.v1_0.CartItem;
...
public class CartItemSerDes {
	...
	public static String toJSON(CartItem cartItem) {
		...
		if (cartItem.getShippedQuantity() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(cartItem.getShippedQuantity());
		}
	...
	public static Map<String, String> toMap(CartItem cartItem) {
		...
		if (cartItem.getShippedQuantity() == null) {
			...
			map.put(
				"shippedQuantity",
				String.valueOf(cartItem.getShippedQuantity()));
		}
