...
@Component
@GraphQLTypeWiring(
	fieldName = "orderAccountAverageCurrencyValues", typeName = "QueryType"
)
public class OrderAccountAverageCurrencyValuesDataFetcher
	...
	public List<CurrencyValueDTO> get(
		...
		return ListUtil.map(
			orderAccountAverageCurrencyValues.values(), CurrencyValueDTO::new);
	}
