 ...
 * @author Inácio Nery
 */
public class PageReferrerMetricTest
	extends BaseBeanTestCase<PageReferrerMetric> {

	public PageReferrerMetricTest() {
		super(
	...
	public void testEqualsAndHashCode() {
		EqualsVerifier<? extends Object> equalsVerifier =
			EqualsVerifier.forClass(PageReferrerMetric.class);
	...
	@Override
	protected PageReferrerMetric newInstance() {
		return new PageReferrerMetric();
	}
