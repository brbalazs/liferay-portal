...
public class OrderIncompleteCurrencyValueWithTrendGraphQLRestControllerTest
	...
	public String getBodyPath() {
		return "order_incomplete_currency_value_with_trend_body.json";
	}

	@Override
	public String getExpectedResultPath() {
		return "order_incomplete_currency_value_with_trend_expected_result.json";
	}

	@Override
	public String getQueryPath() {
		return "order_incomplete_currency_value_with_trend_query.graphql";
	}
