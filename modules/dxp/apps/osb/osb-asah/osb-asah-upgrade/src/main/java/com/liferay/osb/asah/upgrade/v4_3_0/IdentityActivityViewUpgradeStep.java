 ...
 */
@Component
public class IdentityActivityViewUpgradeStep implements UpgradeStep {
	...
	public void upgrade(String version) throws Exception {
		...
		if (_log.isInfoEnabled()) {
			_log.info("Identity Activity view successfully updated");
		}
	}

	private static final Log _log = LogFactory.getLog(
		IdentityActivityViewUpgradeStep.class);
