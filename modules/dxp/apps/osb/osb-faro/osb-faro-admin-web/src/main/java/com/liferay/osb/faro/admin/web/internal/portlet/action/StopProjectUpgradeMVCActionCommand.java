...
@Component(
	...
	property = {
		...
		"mvc.command.name=/faro_admin/stop_project_upgrade"
	},
	service = MVCActionCommand.class
)
public class StopProjectUpgradeMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		if (faroProjectId > 0) {
			_upgradeExecutor.stop(faroProjectId);
		}
		else {
			_upgradeExecutor.stop();
		}
	}
