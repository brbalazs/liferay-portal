...
public class FaroChannelUtil {
	...
	private static ServiceTracker
		<FaroChannelPersistence, FaroChannelPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(FaroChannelPersistence.class);

		ServiceTracker<FaroChannelPersistence, FaroChannelPersistence>
			serviceTracker =
				new ServiceTracker
					<FaroChannelPersistence, FaroChannelPersistence>(
						bundle.getBundleContext(), FaroChannelPersistence.class,
						null);
