...
public interface FaroNotificationPersistence
	 ...
	 */
	public java.util.List<FaroNotification> findByC(long createTime);
	 ...
	 */
	public java.util.List<FaroNotification> findByC(
	 ...
	 * @return the matching faro notifications
	 */
	public java.util.List<FaroNotification> findByG_C_C(
