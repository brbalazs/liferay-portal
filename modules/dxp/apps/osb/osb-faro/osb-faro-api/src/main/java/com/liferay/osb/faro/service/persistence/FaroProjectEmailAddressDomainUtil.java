...
public class FaroProjectEmailAddressDomainUtil {
	...
	private static ServiceTracker
		<FaroProjectEmailAddressDomainPersistence,
		 FaroProjectEmailAddressDomainPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			FaroProjectEmailAddressDomainPersistence.class);

		ServiceTracker
			<FaroProjectEmailAddressDomainPersistence,
			 FaroProjectEmailAddressDomainPersistence> serviceTracker =
				new ServiceTracker
					<FaroProjectEmailAddressDomainPersistence,
					 FaroProjectEmailAddressDomainPersistence>(
						 bundle.getBundleContext(),
						 FaroProjectEmailAddressDomainPersistence.class, null);
