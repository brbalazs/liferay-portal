...
public class FaroProjectUtil {
	...
	private static ServiceTracker
		<FaroProjectPersistence, FaroProjectPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(FaroProjectPersistence.class);

		ServiceTracker<FaroProjectPersistence, FaroProjectPersistence>
			serviceTracker =
				new ServiceTracker
					<FaroProjectPersistence, FaroProjectPersistence>(
						bundle.getBundleContext(), FaroProjectPersistence.class,
						null);
