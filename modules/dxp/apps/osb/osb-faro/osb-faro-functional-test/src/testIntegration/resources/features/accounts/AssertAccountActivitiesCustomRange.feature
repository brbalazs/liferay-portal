...
Feature: Set a Custom Range time filter for Account Activities
	...
	Scenario: Set a Custom Range time filter for Account Activities
		...
		And I set start date "July 1 2020" and end date "August 11 2020"
		Then I should see time filter "Jul 1, 2020 - Aug 11, 2020" in card
		And I should see granularity starts "Jul 1" and ends "Aug 11" in "Account Activities" card