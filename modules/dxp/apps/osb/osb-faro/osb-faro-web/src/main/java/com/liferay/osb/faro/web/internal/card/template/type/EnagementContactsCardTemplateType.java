...
import com.liferay.osb.faro.web.internal.model.display.contacts.card.template.EngagementContactsCardTemplateDisplay;
...
public class EnagementContactsCardTemplateType
	...
	public Class<? extends ContactsCardTemplateDisplay> getDisplayClass() {
		return EngagementContactsCardTemplateDisplay.class;
	}

	@Override
	public int getType() {
		return ContactsCardTemplateConstants.TYPE_ENGAGEMENT;
	}

	private static final String _DEFAULT_NAME = "Engagement";
