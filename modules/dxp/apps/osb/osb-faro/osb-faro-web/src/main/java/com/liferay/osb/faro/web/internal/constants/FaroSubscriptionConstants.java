...
public class FaroSubscriptionConstants {
	...
	private static final Map<String, FaroSubscriptionPlan>
		_faroSubscriptionPlans = new HashMap<String, FaroSubscriptionPlan>() {
			{
				put(
				...
				put(
					...
					new FaroSubscriptionPlan(
						...
						ProductConstants.BUSINESS_CONTACTS_PRODUCT_NAME, 5000,
						0, 1500));
				put(
					ProductConstants.BUSINESS_PRODUCT_NAME,
					new FaroSubscriptionPlan(
				...
				put(
					...
					new FaroSubscriptionPlan(
						...
						ProductConstants.ENTERPRISE_CONTACTS_PRODUCT_NAME, 5000,
						0, 500));
				put(
					ProductConstants.ENTERPRISE_PRODUCT_NAME,
					new FaroSubscriptionPlan(
	...
	private static final Map<String, Integer> _statuses =
		new HashMap<String, Integer>() {
			{
				put("approaching", STATUS_LIMIT_APPROACHING);
				put("ok", STATUS_OK);
				put("over", STATUS_LIMIT_OVER);
			}
		};
