...
import {AttributeTypes, DataTypes, DateGroupings, Operators} from '../types';

describe('utils', () => {
	describe('getBreakdownDisplay', () => {
		it.each`
			dataType              | type                         | operator                 | value                           | result                                                    | dateGrouping            | bin
			${DataTypes.Boolean}  | ${AttributeTypes.Account}    | ${Operators.EQ}          | ${[true]}                       | ${['Account | Test', 'True']}                             | ${null}                 | ${null}
			${DataTypes.Boolean}  | ${AttributeTypes.Account}    | ${Operators.EQ}          | ${[false]}                      | ${['Account | Test', 'False']}                            | ${null}                 | ${null}
			${DataTypes.Date}     | ${AttributeTypes.Event}      | ${Operators.Between}     | ${['2021-01-20', '2021-01-24']} | ${['Event | Test', 'Month, Jan 20, 2021 - Jan 24, 2021']} | ${DateGroupings.Months} | ${null}
			${DataTypes.Date}     | ${AttributeTypes.Event}      | ${Operators.Between}     | ${['2021-01-20', '2021-01-24']} | ${['Event | Test', 'Year, Jan 20, 2021 - Jan 24, 2021']}  | ${DateGroupings.Years}  | ${null}
			...
			${DataTypes.String}   | ${AttributeTypes.Event}      | ${Operators.Contains}    | ${['Hello World']}              | ${['Event | Test', 'contains "Hello World"']}             | ${null}                 | ${null}
			${DataTypes.String}   | ${AttributeTypes.Event}      | ${Operators.NotContains} | ${['Hello World']}              | ${['Event | Test', 'not contains "Hello World"']}         | ${null}                 | ${null}
			${DataTypes.String}   | ${AttributeTypes.Event}      | ${Operators.EQ}          | ${['Hello World']}              | ${['Event | Test', 'is "Hello World"']}                   | ${null}                 | ${null}
			${DataTypes.String}   | ${AttributeTypes.Event}      | ${Operators.NE}          | ${['Hello World']}              | ${['Event | Test', 'is not "Hello World"']}               | ${null}                 | ${null}
		`(
