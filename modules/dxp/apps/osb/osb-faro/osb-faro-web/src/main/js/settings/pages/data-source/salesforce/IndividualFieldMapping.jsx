...
export class IndividualFieldMapping extends React.Component {
	static propTypes = {
	...
	render() {
		...
		return (
			<BaseFieldMappingView
				{...omitDefinedProps(
					otherProps,
					IndividualFieldMapping.propTypes
				)}
				breadcrumbItems={[
					...
					{
						active: true,
						label: Liferay.Language.get('individual-field-mapping')
					}
				]}
				...
				title={Liferay.Language.get('individual-field-mapping')}
			/>
		);
	}
}
