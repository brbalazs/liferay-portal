...
test(
    ...
    async ({
        ...
        try {
            ...
            await permissionsPage.checkPermissionsAndSave(childFolderPermissions);
            ...
            await permissionsPage.checkPermissionsAndSave(childContentPermissions);
            ...
            await page.locator('.alert-info').getByRole('button', {name: 'Close'}).click();
            ...
            childContentPermissions = [
                {action: 'DELETE_DISCUSSION', checked: false, role: 'Power User'},
