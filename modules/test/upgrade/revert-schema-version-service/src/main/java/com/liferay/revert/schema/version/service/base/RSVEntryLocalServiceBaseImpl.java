...
public abstract class RSVEntryLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, RSVEntryLocalService {
	...
	/**
	 * Returns the rsv entry local service.
	 *
	 * @return the rsv entry local service
	 */
	public RSVEntryLocalService getRSVEntryLocalService() {
		return rsvEntryLocalService;
	}

	/**
	 * Sets the rsv entry local service.
	 *
	 * @param rsvEntryLocalService the rsv entry local service
	 */
	public void setRSVEntryLocalService(
		RSVEntryLocalService rsvEntryLocalService) {

		this.rsvEntryLocalService = rsvEntryLocalService;
	}

	/**
	 * Returns the rsv entry persistence.
	 *
	 * @return the rsv entry persistence
	 */
	public RSVEntryPersistence getRSVEntryPersistence() {
		return rsvEntryPersistence;
	}

	/**
	 * Sets the rsv entry persistence.
	 *
	 * @param rsvEntryPersistence the rsv entry persistence
	 */
	public void setRSVEntryPersistence(
		RSVEntryPersistence rsvEntryPersistence) {

		this.rsvEntryPersistence = rsvEntryPersistence;
	}
	...
	@BeanReference(type = RSVEntryLocalService.class)
	protected RSVEntryLocalService rsvEntryLocalService;

	@BeanReference(type = RSVEntryPersistence.class)
