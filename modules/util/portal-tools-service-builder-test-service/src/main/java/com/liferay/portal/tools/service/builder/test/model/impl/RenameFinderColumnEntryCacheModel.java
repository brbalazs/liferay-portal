...
public class RenameFinderColumnEntryCacheModel
	...
	public RenameFinderColumnEntry toEntityModel() {
		...
		if (renamedColumn == null) {
			renameFinderColumnEntryImpl.setRenamedColumn("");
		}
		else {
			renameFinderColumnEntryImpl.setRenamedColumn(renamedColumn);
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		renamedColumn = objectInput.readUTF();
	}
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		...
		if (renamedColumn == null) {
			...
			objectOutput.writeUTF(renamedColumn);
		}
	}

	public long renameFinderColumnEntryId;
	public long groupId;
	public String renamedColumn;
