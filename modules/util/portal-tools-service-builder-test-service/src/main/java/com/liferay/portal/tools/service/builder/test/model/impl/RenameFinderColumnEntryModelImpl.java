...
public class RenameFinderColumnEntryModelImpl
	...
	private static Function<InvocationHandler, RenameFinderColumnEntry>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			RenameFinderColumnEntry.class.getClassLoader(),
			RenameFinderColumnEntry.class, ModelWrapper.class);

		try {
			Constructor<RenameFinderColumnEntry> constructor =
				(Constructor<RenameFinderColumnEntry>)proxyClass.getConstructor(
		...
		attributeGetterFunctions.put(
			...
			new Function<RenameFinderColumnEntry, Object>() {
				...
				public Object apply(
					...
					return renameFinderColumnEntry.getGroupId();
				}
	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<RenameFinderColumnEntry, Object>() {
				...
				public void accept(
					RenameFinderColumnEntry renameFinderColumnEntry,
					Object renamedColumnObject) {

					renameFinderColumnEntry.setRenamedColumn(
						(String)renamedColumnObject);
				}
