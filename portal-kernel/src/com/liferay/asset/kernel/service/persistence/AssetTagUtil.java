...
public class AssetTagUtil {
	 ...
	 */
	public static List<AssetTag> filterFindByGroupId(
		long groupId, int start, int end) {
	 ...
	 * @throws NoSuchTagException if a asset tag with the primary key could not be found
	 */
	public static AssetTag[] filterFindByGroupId_PrevAndNext(
			long tagId, long groupId,
			OrderByComparator<AssetTag> orderByComparator)
		throws com.liferay.asset.kernel.exception.NoSuchTagException {
	 ...
	 * @return the matching asset tags that the user has permission to view
	 */
	public static List<AssetTag> filterFindByG_LikeN(
		long groupId, String name) {
	 ...
	 * @throws NoSuchTagException if a asset tag with the primary key could not be found
	 */
	public static AssetTag[] filterFindByG_LikeN_PrevAndNext(
			long tagId, long groupId, String name,
			OrderByComparator<AssetTag> orderByComparator)
		throws com.liferay.asset.kernel.exception.NoSuchTagException {
